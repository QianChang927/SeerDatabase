package com.robot.app.mapProcess.control.spcaeMaze
{
   ...
   public class SpaceMazeMiniMap
   {
      ...
      private static var _controller:SpaceMazeController;
      ...
      public static function show() : void
      {
         var _loc1_:uint = 0;
         var _loc2_:uint = 0;
         _controller = SpaceMazeController.getInstance();
      ...
      public static function destroy(param1:Boolean = false) : void
      {
         ...
         if(_controller)
         {
            _controller.removeEventListener(SpaceMazeController.CHANGE_ROOM,onChangeRoom);
            _controller = null;
         }
      }
   }
