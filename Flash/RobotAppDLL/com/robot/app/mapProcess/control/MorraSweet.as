package com.robot.app.mapProcess.control
{
   ...
   public class MorraSweet
   {
      ...
      private static var _instance:com.robot.app.mapProcess.control.MorraSweet;
      ...
      public static function getInstance() : com.robot.app.mapProcess.control.MorraSweet
      {
         if(!_instance)
         {
            _instance = new com.robot.app.mapProcess.control.MorraSweet();
         }
         return _instance;
      }
