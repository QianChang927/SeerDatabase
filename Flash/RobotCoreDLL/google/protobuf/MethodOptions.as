package google.protobuf
{
   ...
   public final dynamic class MethodOptions extends Message
   {
      
      public static const extensionReadFunctions:Array = [];
      
      public static const UNINTERPRETED_OPTION:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("google.protobuf.MethodOptions.uninterpreted_option","uninterpretedOption",999 << 3 | WireType.LENGTH_DELIMITED,function():Class
      {
