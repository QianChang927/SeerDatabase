      ...
      private function npc1Handle() : void
      {
         if(this.intask)
         {
            if(this.daytasktwoover)
            {
               ...
               {
                  NpcDialog.show(4526,["谢谢你！这样，我就可以更快地完成今晚篝火节的准备工作了！"],["不客气！"],[function():void
                  {
            ...
            {
               NpcDialog.show(4526,["快帮帮我吧，我要来不及准备了！"],["我这就去！"],[function():void
               {
         ...
         {
            NpcDialog.show(4526,["篝火晚会将于18:00开启，听说会有很多绝版的精灵前来狂欢！如果你想获得它们，届时一定要来参加哦！"],["我一定会来的！"],[function():void
            {
            }],false,null,true);
         }
         else
         {
            NpcDialog.show(4526,["篝火晚会将于18:00开启，听说会有很多绝版的精灵前来狂欢哦！我还有一些准备工作没有做好，你愿意帮帮我吗？这将让你更快地获得它们！"],["放着我来","我还有别的事情要忙。"],[function():void
            {
               if(daytaskpro == 0)
               {
                  NpcDialog.show(4526,["篝火晚会需要用到大量的木材，为了防止滥砍滥伐，我们一年只会举行一次！你能否帮我去后面的小树林里再弄一些木材过来？"],["当然没问题！"],[function():void
                  {
               ...
               {
                  NpcDialog.show(4526,["想要营造出篝火晚会的氛围，不仅要有一团大篝火，还要有很多小篝火来衬托才行！天色将晚，这里的海边有很多火盆，你能帮我把它们全部点燃吗？"],["当然没问题！"],[function():void
                  {
