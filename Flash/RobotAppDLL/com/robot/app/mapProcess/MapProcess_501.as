package com.robot.app.mapProcess
{
   ...
   public class MapProcess_501 extends BaseMapProcess
   {
      ...
      override protected function init() : void
      {
         ...
         while(_loc1_ < 5)
         {
            _loc2_ = conLevel["btn" + _loc1_];
            _loc2_.addEventListener(MouseEvent.CLICK,this.onBtnClickHandler);
            _loc1_++;
         }
      ...
      override public function destroy() : void
      {
         ...
         {
            _loc2_ = conLevel["btn" + _loc1_];
            _loc2_.removeEventListener(MouseEvent.CLICK,this.onBtnClickHandler);
            _loc1_++;
         }
