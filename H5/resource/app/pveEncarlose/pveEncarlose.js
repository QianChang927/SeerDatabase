...
function(e) {
    var t = function(t) {
        ...
        i.prototype.showTime = function() {
            return this._time--,
            this._time <= 0 ? (egret.clearInterval(this._interval), this.candle_off.visible = !1, this.candle_on.visible = !0, void(SocketConnection.mainSocket.connected ? SocketConnection.sendByQueue(43284, [12, 2],
            function() {
                Alarm.show("恭喜你完成玄武祈福！",
                function() {
                    e.PveEncarloseManager.getInstance().stopTask()
                })
            }) : EventManager.once(SocketEvent.SOCKETRECONNECT,
            function() {
                SocketConnection.sendByQueue(43284, [12, 2],
                function() {
                    Alarm.show("恭喜你完成玄武祈福！",
                    function() {
                        e.PveEncarloseManager.getInstance().stopTask()
            ...
            this))) : void(this.txt_time.text = "00:" + core.gameUtil.addLeadingZero(this._time))
        },
        i.prototype.onStep = function() {
