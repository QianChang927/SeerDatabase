package com.robot.app2.mapProcess.control
{
   ...
   public class WeeklyVSController2
   {
      ...
      private static const time_str:String = "4月17日—4月23日，每天13:00—14:00";
      
      private static var time_p2:CronTimeVo = new CronTimeVo("*","13","17-23","4","*","2015");
      
      private static var lastDay:CronTimeVo = new CronTimeVo("*","*","23","4","*","2015");
      
      private static var time_e4:CronTimeVo = new CronTimeVo("55-60","13","17-23","4","*","2015");
      ...
      public function WeeklyVSController2()
      {
         super();
      }
      ...
      private static function onGetMsgTime(param1:SocketEvent) : void
      {
         ...
         {
            LocalMsgController.addLocalMsg("TwelveRounds/WeeklyVSMsgPanel2",0,false,null,null,1);
      ...
      public static function initEquip() : void
      {
         if(MapManager.currentMap.id != TARGET_MAP)
         {
            ModuleManager.showModule(ClientConfig.getAppModule("TwelveRounds/WeeklyVSMsgPanel2"),"正在努力打开面板...");
         }
         else
         {
