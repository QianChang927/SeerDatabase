package com.robot.app.games.waterGunGame
{
   ...
   public class WaterGunGame
   {
      ...
      private static var PATH:String = ClientConfig.getResPath("Games/waterGame/WaterGame.swf");
      ...
      private static var waterGameAward:com.robot.app.games.waterGunGame.WaterGameAward;
      ...
      private static function onGameOver(param1:Event) : void
      {
         ...
         if(_loc2_.flag == 0)
         {
            waterGameAward = new com.robot.app.games.waterGunGame.WaterGameAward();
            EventManager.addEventListener(com.robot.app.games.waterGunGame.WaterGameAward.GET_WATER_GUN_GAME_AWARD_OK,onGetItemsOk);
         }
      ...
      {
         EventManager.removeEventListener(com.robot.app.games.waterGunGame.WaterGameAward.GET_WATER_GUN_GAME_AWARD_OK,onGetItemsOk);
         waterGameAward.destroy();
         if(com.robot.app.games.waterGunGame.WaterGameAward.bExist)
         {
