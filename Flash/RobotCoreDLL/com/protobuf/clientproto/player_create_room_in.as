package com.protobuf.clientproto
{
   ...
   public final dynamic class player_create_room_in extends Message
   {
      
      public static const ROOMMODE:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("com.protobuf.clientproto.player_create_room_in.roommode","roommode",1 << 3 | WireType.VARINT);
       
      
      public var roommode:uint;
      
      public function player_create_room_in()
      {
         super();
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc4_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: player_create_room_in.roommode cannot be set twice.");
                  }
                  _loc3_++;
