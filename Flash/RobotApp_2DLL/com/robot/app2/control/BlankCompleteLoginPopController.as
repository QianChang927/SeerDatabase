package com.robot.app2.control
{
   ...
   public class BlankCompleteLoginPopController
   {
      
      public static var TIME_VO_AM:Array = [new CronTimeVo("*","12-13","*","*","*","*")];
      ...
      public function BlankCompleteLoginPopController()
      {
         super();
      }
      ...
      private static function showPopUp() : void
      {
         if(_ui == null)
         {
            ResourceManager.getResource(ClientConfig.getAppResource("2016/1104/BlankCompleteLoginPopPanel"),function(param1:MovieClip):void
            {
               _ui = param1;
               _ui.x = 548;
               _ui.y = 560;
               ...
               _loc3_.initialSeconds = (_loc2_.hours >= 20 ? 24 + 12 - _loc2_.hours : (_loc2_.hours >= 14 ? 18 - _loc2_.hours : 12 - _loc2_.hours)) * 3600 - _loc2_.minutes * 60 - _loc2_.seconds;
               _loc3_.start(hide);
            });
         }
      }
      ...
      private static function onClick(param1:MouseEvent) : void
      {
         switch(param1.target.name)
         {
            case "jump_1":
               hide();
               ModuleManager.showAppModule("BlankCompleteMainPanel");
               break;
            case "close":
               hide();
         }
