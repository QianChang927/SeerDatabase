package com.robot.app2.mapProcess
{
   ...
   public class MapProcess_1405 extends BaseMapProcess
   {
       
      
      public function MapProcess_1405()
      {
         super();
      }
      ...
      public function onMouseClick(param1:MouseEvent) : void
      {
         ...
         {
            case "btn":
               conLevel["mc"]["ani"].visible = true;
               btnLevel["btn"].visible = false;
               AnimateManager.playMcAnimate(conLevel["mc"],1,"ani",function():void
               {
