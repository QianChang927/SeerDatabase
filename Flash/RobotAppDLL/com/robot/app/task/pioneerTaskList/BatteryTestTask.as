package com.robot.app.task.pioneerTaskList
{
   ...
   public class BatteryTestTask extends Sprite
   {
      ...
      private const url_str:String = ClientConfig.getResPath("Games/BatteryTestTask.swf");
      ...
      private function addBattery() : void
      {
         ...
         while(_loc1_ < 4)
         {
            _loc2_ = new (this.app.getDefinition("battery_mc") as Class)() as Sprite;
            _loc2_.name = "battery" + _loc1_;
            _loc2_.useHandCursor = true;
            _loc2_.buttonMode = true;
            this.batteryLevel.addChild(_loc2_);
            _loc2_.x = 620 + (_loc2_.width + 10) * _loc1_;
            _loc2_.y = 465;
            _loc2_.addEventListener(MouseEvent.MOUSE_DOWN,this.onBatteryDownHandler);
            _loc1_++;
         }
      }
      ...
      private function addShip() : void
      {
         ...
         while(_loc1_ < 3)
         {
            _loc2_ = new (this.app.getDefinition("ship_mc") as Class)() as Sprite;
            this.addChild(_loc2_);
            _loc2_.name = "ship" + _loc1_;
            (_loc2_ as MovieClip).gotoAndStop(1);
            _loc2_.x = 610 + (_loc2_.width + 8) * _loc1_;
            _loc2_.y = 12;
            _loc1_++;
         }
      }
