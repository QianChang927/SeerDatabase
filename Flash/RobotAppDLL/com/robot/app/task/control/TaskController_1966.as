package com.robot.app.task.control
{
   ...
   public class TaskController_1966
   {
      
      public static const TASK_ID:uint = 1966;
      ...
      public static const MAP_LOCAL_ID1:int = 10470;
      
      public static const MAP_LOCAL_ID2:int = 10471;
      
      public static const MAP_LOCAL_ID3:int = 10472;
      
      public static const MAP_LOCAL_ID4:int = 10473;
      ...
      public function TaskController_1966()
      {
         super();
      }
      ...
      {
         NpcDialog.show(NPC.SHIPER,[MainManager.actorInfo.formatNick + "，我决不允许卡修斯被该死的魔石精灵控制！卡修斯是我们的好朋友，我们一定要帮助卡修斯，绝对不能让邪恶势力得逞。 "],["我立刻去船长商量对策！（奖励十万经验券，上等体力药剂，泰坦之灵）","让我先准备一下！"],[function():void
         {
