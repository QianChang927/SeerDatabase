package com.robot.core.skeleton
{
   ...
   public class EmptySkeletonStrategy implements ISkeleton
   {
      ...
      private var clothPrev:com.robot.core.skeleton.SkeletonClothPreview;
      ...
      {
         this._info = param1;
         this._people.execBehavior(new ChangeClothBehavior(this._info.clothes,false));
         this.changeColor(this._info.color);
         if(this._info.texture != 0)
         {
            this.changeDoodle(ClientConfig.getDoodleSwf(this._info.texture));
         }
      }
      ...
      public function set people(param1:ISkeletonSprite) : void
      {
         ...
         this.clothPrev = new com.robot.core.skeleton.SkeletonClothPreview(this.composeMC,this._people);
