package com.oaxoa.fx
{
   ...
   public class Lightning extends Sprite
   {
      ...
      public var parentInstance:com.oaxoa.fx.Lightning;
      ...
      {
         var _loc1_:uint = 0;
         var _loc2_:com.oaxoa.fx.Lightning = null;
         ...
         {
            _loc1_ = 0;
            _loc2_ = this.parent as com.oaxoa.fx.Lightning;
      ...
      {
         var _loc1_:com.oaxoa.fx.Lightning = null;
      ...
      public function generateChild(param1:uint = 1, param2:Boolean = false) : void
      {
         ...
         var _loc8_:com.oaxoa.fx.Lightning = null;
         if(this.generation < this.childrenMaxGenerations && this.childrenArray.length < this.childrenMaxCount)
         {
            ...
            if(_loc3_ >= 2)
            {
               ...
               while(_loc4_ < param1)
               {
                  ...
                  (_loc8_ = new com.oaxoa.fx.Lightning(this.color,this.thickness,this.generation + 1)).parentInstance = this;
