package com.robot.core.info
{
   ...
   public class UserInfo
   {
      ...
      public function UserInfo()
      {
         ...
         this.nonoState = [];
         this.dailyResArr = [];
         this.summerHolidaysArr = [];
         this.dailyTaskWeekHotArr = [];
         this.bufferRecordArr = [];
         this.nonoChipList = [];
         super();
      }
      ...
      public static function setForPeoleInfo(param1:UserInfo, param2:IDataInput) : void
      {
         ...
         var _loc11_:GroupInfo;
         (_loc11_ = new GroupInfo()).groupIDInfo = new GroupIDInfo(param2);
         ...
         var _loc12_:TeamInfo;
         (_loc12_ = new TeamInfo()).id = param2.readUnsignedInt();
         ...
         {
            _loc16_ = uint(param2.readUnsignedInt());
            _loc17_ = uint(param2.readUnsignedInt());
            param1.clothes.push(new PeopleItemInfo(_loc16_,_loc17_));
            _loc14_++;
         }
      ...
      public static function setForLoginInfo(param1:UserInfo, param2:IDataInput) : void
      {
         ...
         param1.vip = BitUtil.getBit(_loc4_,0);
         param1.viped = BitUtil.getBit(_loc4_,1);
         var _loc5_:uint = uint(param2.readUnsignedByte());
         param1.isExtremeNono = Boolean(BitUtil.getBit(_loc5_,1));
         if(!param1.isVip)
         {
            param1.isExtremeNono = false;
         }
         ...
         var _loc11_:uint = uint(param2.readUnsignedInt());
         var _loc12_:Array = new Array();
         var _loc13_:int = 0;
         while(_loc13_ < _loc11_)
         {
            _loc12_.push(param2.readUnsignedInt());
            _loc13_++;
         }
         var _loc14_:uint = uint(_loc12_[0]);
         param1.openTiger = Boolean(BitUtil.getBit(_loc14_,0));
         param1.openDragon = Boolean(BitUtil.getBit(_loc14_,1));
         param1.openYanMo = Boolean(BitUtil.getBit(_loc14_,2));
         param1.openSaiBoSiTe = Boolean(BitUtil.getBit(_loc14_,3));
         param1.openGreenDragon = Boolean(BitUtil.getBit(_loc14_,4));
         param1.openJieensi = Boolean(BitUtil.getBit(_loc14_,5));
         param1.openBaenna = Boolean(BitUtil.getBit(_loc14_,6));
         param1.openShiZuLingShou = Boolean(BitUtil.getBit(_loc14_,7));
         param1.openTuoLuKe = Boolean(BitUtil.getBit(_loc14_,8));
         param1.openJixieTacoLyn = Boolean(BitUtil.getBit(_loc14_,9));
         param1.openBasite = Boolean(BitUtil.getBit(_loc14_,10));
         param1.openTaiGuLa = Boolean(BitUtil.getBit(_loc14_,11));
         param1.openBaihu = Boolean(BitUtil.getBit(_loc14_,12));
         param1.openSitanli = Boolean(BitUtil.getBit(_loc14_,14));
         param1.openRuidehaosi = Boolean(BitUtil.getBit(_loc14_,27));
         param1.openDierke = Boolean(BitUtil.getBit(_loc14_,19));
         param1.openWhiteHorse = Boolean(BitUtil.getBit(_loc14_,28));
         param1.openKubeisa = Boolean(BitUtil.getBit(_loc14_,29));
         param1.openBaKeDi = Boolean(BitUtil.getBit(_loc14_,24));
         param1.openSiweila = Boolean(BitUtil.getBit(_loc14_,30));
         param1.openPailabi = Boolean(BitUtil.getBit(_loc14_,31));
         _loc14_ = uint(_loc12_[1]);
         param1.openKaimila = Boolean(BitUtil.getBit(_loc14_,0));
         param1.openKuangyeheiniao = Boolean(BitUtil.getBit(_loc14_,1));
         param1.openQilin = Boolean(BitUtil.getBit(_loc14_,2));
         param1.openNaKaLuoHa = Boolean(BitUtil.getBit(_loc14_,3));
         param1.openGeErBoKe = Boolean(BitUtil.getBit(_loc14_,4));
         param1.openELingShou = Boolean(BitUtil.getBit(_loc14_,5));
         param1.openGhostTiger = Boolean(BitUtil.getBit(_loc14_,6));
         param1.openMegatronTiger = Boolean(BitUtil.getBit(_loc14_,7));
         param1.openPeiluomu = Boolean(BitUtil.getBit(_loc14_,8));
         param1.openYinLeiTianLong = Boolean(BitUtil.getBit(_loc14_,9));
         param1.openHanDiJuLong = Boolean(BitUtil.getBit(_loc14_,10));
         param1.openYikongzhanqi = Boolean(BitUtil.getBit(_loc14_,11));
         param1.mountId = param2.readUnsignedInt();
         ...
         while(_loc16_ < 32)
         {
            param1.nonoState.push(BitUtil.getBit(_loc15_,_loc16_));
            _loc16_++;
         }
         param1.nonoColor = param2.readUnsignedInt();
         ...
         param2.readBytes(_loc17_,0,20);
         param1.reserved = _loc17_;
         var _loc18_:int = 0;
         while(_loc18_ < 1000)
         {
            ...
            while(_loc24_ < 4)
            {
               _loc26_ = (_loc25_ = uint(_loc24_ * 2 + 1)) - 1;
               _loc27_ = uint(BitUtil.getBit(_loc23_,_loc26_));
               if(_loc28_ = Boolean(BitUtil.getBit(_loc23_,_loc25_)))
               {
      ...
      public static function setForSimpleInfo(param1:UserInfo, param2:IDataInput) : void
      {
         ...
         param1.vipLevel = param2.readUnsignedInt();
         var _loc4_:TeamInfo;
         (_loc4_ = new TeamInfo()).id = param2.readUnsignedInt();
