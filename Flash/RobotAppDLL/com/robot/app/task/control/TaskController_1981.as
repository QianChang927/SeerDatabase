package com.robot.app.task.control
{
   ...
   public class TaskController_1981
   {
      
      public static const TASK_ID:uint = 1981;
      ...
      public static const MAP_LOCAL_ID1:int = 10485;
      
      public static const MAP_LOCAL_ID2:int = 10486;
      
      public static const MAP_LOCAL_ID3:int = 10487;
      
      public static const MAP_LOCAL_ID4:int = 10488;
      ...
      public function TaskController_1981()
      {
         super();
      }
      ...
      {
         NpcDialog.show(NPC.SHIPER,[MainManager.actorInfo.formatNick + "，魔灵星之主苏醒，暴露了自己的邪恶本性。我们必须在卡修斯超进化之前，阻止魔灵王的阴谋！他才是真正的魔王！ "],["我立刻就去！（奖励十万经验券，上等体力药剂，泰坦之灵）","让我先准备一下！"],[function():void
         {
