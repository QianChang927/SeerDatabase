package com.robot.app.games.FerruleGame
{
   ...
   public class FerruleGamePanel
   {
      ...
      private static var _instance:com.robot.app.games.FerruleGame.FerruleGamePanel;
      ...
      {
         this.PATH = ClientConfig.getResPath("Games/FerruleGame.swf");
         super();
      }
      
      public static function getInstance() : com.robot.app.games.FerruleGame.FerruleGamePanel
      {
         if(!_instance)
         {
            _instance = new com.robot.app.games.FerruleGame.FerruleGamePanel();
         }
         return _instance;
      }
      ...
      private function onBegainGameHandler(param1:Event) : void
      {
         ...
         this.t = setTimeout(this.init,300);
         if(this.chanel)
         {
            this.chanel.stop();
            this.chanel = null;
         ...
         this.sound = MapManager.currentMap.libManager.getSound("sound");
         this.chanel = this.sound.play();
      }
      
      private function onGameCloseHandler(param1:Event) : void
      {
         DebugTrace.show("CLOSEGAME");
         this.remove();
      }
      ...
      private function onShowCircleHandler(param1:Event) : void
      {
         ...
         DebugTrace.show(this._circleMC.x + "   " + this._circleMC.y);
