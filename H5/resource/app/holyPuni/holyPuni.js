    ...
    var e = function(e) {
        ...
        i.prototype.addEvent = function() {
            ...
            for (var e = function(e) {
                ...
                function() {
                    t.curRecord >= 10 ? SocketConnection.sendByQueue(46342, [8, e + 1 + 10],
                    function() {
                        t.updateData(),
        ...
        i.prototype.updateData = function() {
            var e = this;
            KTool.getMultiValue([4951, 4952, 16652, 4946, 121830],
            function(i) {
                return e.curRecord = i[4],
                i[3] >= 5 ? (Alarm.show("恭喜您，通过了圣灵之环•光明之愿关卡！谱尼的力量变得更强大了！"), void t.HolyPuniManager.getInstance().changePanel(t.HolyPuniManager.MAIN_PANEL)) : (e._showAlarm && e.showAlarm(i[0]), e._lightState = i[0], e._lockState = i[1], e._fightTimes = i[2], void e.updateView())
            })
        },
        ...
        i.prototype.updateView = function() {
            var e = this;
            this.txt_record.text = "激活次数：" + this.curRecord + "/10";
            for (var i = this._lightState,
            n = 0; i;) n++,
            i &= i - 1;
...
generateEUI.paths["resource/eui_skins/HolyPuniLevel5Skin.exml"] = window.HolyPuniLevel5Skin = function(t) {
    function e() {
        t.call(this),
        this.skinParts = ["btnAdd_1", "txt_itemNum_1", "btnAdd_0", "txt_itemNum_0", "btnAdd_2", "txt_leftTimes", "grp_top", "ring_0", "ring_1", "ring_2", "ring_3", "ring_4", "ring_5", "btnActive", "txt_record", "grp_ring", "boss_0", "boss_1", "btnFight", "grp_fight", "btnOneTap", "imgBtn_pet", "imgBtn_cure", "btns"],
        this.height = 640,
        this.width = 1136,
    ...
    h.grp_ring_i = function() {
        ...
        t.visible = !0,
        t.elementsContent = [this._Image7_i(), this.ring_0_i(), this.ring_1_i(), this.ring_2_i(), this.ring_3_i(), this.ring_4_i(), this.ring_5_i(), this.btnActive_i(), this._Image8_i(), this.txt_record_i()],
        t
    },
    ...
    h._Image8_i = function() {
        ...
        t.source = "holy_puni_level_5_recordtips_png",
        t.y = 406.748,
        t
    },
    h.txt_record_i = function() {
        var t = new eui.Label;
        return this.txt_record = t,
