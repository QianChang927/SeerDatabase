package com.robot.app2.control
{
   ...
   public class IceIronWallMoyeSiSuperEvolutionController
   {
      
      private static var _isTaskPlaying:Boolean;
      
      public static const BUFFER_ID:uint = 1203;
      
      private static var _map:MapModel;
       
      
      public function IceIronWallMoyeSiSuperEvolutionController()
      {
         super();
      }
      ...
      private static function startPreTask() : void
      {
         ...
         story = [[TaskStoryPlayer.FUL_MOVIE,["task_iceIronWallMoyeSiSuperEvolution",true]]];
      ...
      {
         ModuleManager.showModule(ClientConfig.getAppModule("IceIronWallMoyeSiSuperEvolutionMainPanel"));
      }
