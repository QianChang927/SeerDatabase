package com.robot.core.xmlInfo
{
   ...
   public class FirstMapPosInfo
   {
      ...
      public function FirstMapPosInfo()
      {
         super();
      }
      ...
      private static function setup(param1:Function) : void
      {
         ...
         _urlLoader.load(new URLRequest(ClientConfig.getResPath("xml/firstMapPos.xml")));
      }
