package com.robot.app.task.control
{
   ...
   public class TaskController_1996
   {
      
      public static const TASK_ID:uint = 1996;
      ...
      public static const MAP_LOCAL_ID1:int = 10505;
      
      public static const MAP_LOCAL_ID2:int = 10506;
      
      public static const MAP_LOCAL_ID3:int = 10507;
      
      public static const MAP_LOCAL_ID4:int = 10508;
      ...
      public function TaskController_1996()
      {
         super();
      }
      ...
      {
         var dialogArr:Array = [MainManager.actorInfo.formatNick + "，太棒啦！卡修斯成功封神，成为举世无双的大地之神！但是前方飞船发来战报，发现缪斯晕倒在德拉诺荒漠。快去和先锋队一起，去看看发生了什么事！"];
