package com.protobuf.clientproto
{
   ...
   public final dynamic class room_ivit_in extends Message
   {
      
      public static const USERID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("com.protobuf.clientproto.room_ivit_in.userid","userid",1 << 3 | WireType.VARINT);
       
      
      public var userid:uint;
      
      public function room_ivit_in()
      {
         super();
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc4_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: room_ivit_in.userid cannot be set twice.");
                  }
                  _loc3_++;
