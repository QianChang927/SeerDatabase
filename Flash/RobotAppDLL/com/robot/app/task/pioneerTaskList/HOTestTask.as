package com.robot.app.task.pioneerTaskList
{
   ...
   public class HOTestTask extends Sprite
   {
      ...
      private const url_str:String = ClientConfig.getResPath("Games/HOTestTaskGame.swf");
      ...
      private function setTimer1() : void
      {
         ...
         this.mainUI_mc["yan_mc"].visible = false;
         this.mainUI_mc["yan_mc"]["yan"].gotoAndStop(1);
         NpcTipDialog.show("真不错！你还知道氢气是氧气的2倍量时能够爆出最大火焰。喷火装备拿好，快去克洛斯星上用它制服蘑菇怪。",this.taskComplete,this.dd,0,this.taskComplete);
      }
