package com.robot.app2.mapProcess.control
{
   ...
   public class PonyDeathDarkShadowController
   {
      
      private static var _map:BaseMapProcess;
       
      
      public function PonyDeathDarkShadowController()
      {
         super();
      }
      
      public static function initMap1125(param1:BaseMapProcess) : void
      {
         _map = param1;
         _map.conLevel.addEventListener(MouseEvent.CLICK,onClick);
      }
      
      public static function destroyMap1125() : void
      {
      ...
      private static function onClick(param1:MouseEvent) : void
      {
         ...
         if(e.target.name == "btnPet")
         {
            if(BitBuffSetClass.getState(22884))
            {
               ModuleManager.showAppModule("PonyDeathDarkShadowMainPanel");
            }
            else
            {
               playMovie("pony_death_dark_shadow_pre",function():void
               {
                  BitBuffSetClass.setState(22884,1);
                  ModuleManager.showAppModule("PonyDeathDarkShadowMainPanel");
               });
            }
         }
