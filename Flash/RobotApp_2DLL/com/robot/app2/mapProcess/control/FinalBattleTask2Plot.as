package com.robot.app2.mapProcess.control
{
   ...
   public class FinalBattleTask2Plot extends PlotUITask
   {
      ...
      public function FinalBattleTask2Plot()
      {
         super("2019/0201/FinalBattleTask2Plot");
      }
      ...
      override public function init(param1:* = null) : void
      {
         var i:int;
         var arr:* = param1;
         this.bossIds = [MapProcess_11804.curMapIndex == 1 ? 15200 : 15225];
         this.petIds = arr[1];
      ...
      override protected function onClick(param1:MouseEvent) : void
      {
         ...
         switch(param1.target.name)
         {
            ...
            case "cure":
               ...
               break;
            case "fight_" + _loc2_:
               FightManager.fightNoMapBoss("",this.bossIds[_loc2_ - 1]);
         }
      }
         ...
         switch(npcId)
         {
            case 1:
               new PlayTalksAction({
                  "name":"talk1",
                  "type":"talks",
                  "value":[[this.npcDialogIds[0],"你终于来了，勇士。快帮帮我，这次可不能让" + PetXMLInfo.getName(this.petIds[1]) + "逃掉。","没问题！"]]
            ...
            case 2:
               new PlayTalksAction({
                  "name":"talk1",
                  "type":"talks",
                  "value":[[this.npcDialogIds[1],"就你这身手还想抓我，拜拜了您呐！","可恶！"]]
            ...
            case 3:
               new PlayTalksAction({
                  "name":"talk1",
                  "type":"talks",
                  "value":[[this.npcDialogIds[0],"还好你及时赶到，不然真给它跑了。谢谢你！","不客气！"]]
               }).doAction().then(function():Promise
               {
                  return SocketConnection.sendWithPromise(43307,[4,(MapProcess_11804.curMapIndex - 1) * 5 + 2]);
               }).then(function():void
      ...
      override protected function updateState() : void
      {
         ...
         KTool.getMultiValue([10612,10603],function(param1:Array):void
         {
            hasComplete = KTool.getByte(param1[1],MapProcess_11804.curMapIndex == 1 ? 2 : 3) == 1;
            leftHhNum = 10 - KTool.getByte(param1[0],0);
            if(leftHhNum < 0)
            {
               leftHhNum = 0;
            }
            ui["btn_mc"]["txt_1"].text = leftHhNum;
            if(hasComplete)
            {
               if(leftHhNum > 0)
               {
            ...
            else if(StaticObjectControll.getObjectByKey("FinalBattleTask") as int == 0 && leftHhNum == 10)
            {
               onNpcClick(1);
