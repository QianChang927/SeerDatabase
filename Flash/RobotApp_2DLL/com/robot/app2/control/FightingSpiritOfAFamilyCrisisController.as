package com.robot.app2.control
{
   ...
   public class FightingSpiritOfAFamilyCrisisController
   {
      
      private static var _isTaskPlaying:Boolean;
      
      public static const BUFFER_ID:uint = 1211;
      ...
      public function FightingSpiritOfAFamilyCrisisController()
      {
         super();
      }
      ...
      private static function startPreTask() : void
      {
         ...
         story = [[TaskStoryPlayer.FUL_MOVIE,["task_fightingSpiritOfAFamilyCrisis",true]]];
      ...
      {
         ModuleManager.showModule(ClientConfig.getAppModule("FightingSpiritOfAFamilyCrisisMainPanel"));
      }
      ...
      {
         ResourceManager.getResource(ClientConfig.getAppRes("FightingSpiritOfAFamilyCrisisTv"),function(param1:MovieClip):void
         {
            _widget = param1;
