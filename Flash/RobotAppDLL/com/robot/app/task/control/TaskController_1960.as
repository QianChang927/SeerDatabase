package com.robot.app.task.control
{
   ...
   public class TaskController_1960
   {
      
      public static const TASK_ID:uint = 1960;
      ...
      public static const MAP_LOCAL_ID1:int = 10459;
      
      public static const MAP_LOCAL_ID2:int = 10460;
      
      public static const MAP_LOCAL_ID3:int = 10461;
      
      public static const MAP_LOCAL_ID4:int = 10462;
      ...
      public function TaskController_1960()
      {
         super();
      }
      ...
      {
         NpcDialog.show(NPC.SHIPER,[MainManager.actorInfo.formatNick + "赛尔先锋队冲锋陷阵，收集到了泰坦石的能量。但是貌似这股能量非比寻常。勇敢地赛尔们，快去看看发生了什么事！"],["船长，我们去看看吧！（奖励十万经验券，乐园代币，上等体力药剂x5）","让我先准备一下！"],[function():void
         {
