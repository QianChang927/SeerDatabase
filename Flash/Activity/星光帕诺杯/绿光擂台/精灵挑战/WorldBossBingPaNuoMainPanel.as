package com.robot.module.app
{
   ...
   public class WorldBossBingPaNuoMainPanel extends ActivityModel
   {
      ...
      {
         super.show();
         StatManager.sendStat2014("1025世界BOSS·草帕诺","进入【世界BOSS·草帕诺】活动主界面","2024运营活动");
      ...
      override protected function updatePanel() : void
      {
         ...
         this.leftDays = this.curTime.getDate() - 24;
         if(this.leftDays == 1)
         {
            this.curDayIndex = 1;
         }
      ...
      private function updateDisplay() : void
      {
         ...
         if(SystemTimerManager.getIsInActivity("20241101","*"))
         {
      ...
      private function showRankPage() : void
      {
         ...
         if(this.curRankBtn == 1)
         {
            ...
            {
               KTool.getGlobalSubkeyValues(288,[this.curDayIndex,this.curDayIndex + 1,this.curDayIndex + 2,this.curDayIndex + 3,this.curDayIndex + 4,this.curDayIndex + 5],function(arr:Array):void
               {
         ...
         else
         {
            ...
            {
               KTool.getGlobalSubkeyValues(288,[this.curToDayIndex,this.curToDayIndex + 1,this.curToDayIndex + 2,this.curToDayIndex + 3,this.curToDayIndex + 4,this.curToDayIndex + 5],function(arr:Array):void
               {
                  if(arr[1] >= arr[3] && arr[1] >= arr[5])
                  {
                     _ui["page_3"]["mc_1"].gotoAndStop(1);
