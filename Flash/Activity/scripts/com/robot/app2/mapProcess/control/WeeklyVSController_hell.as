package com.robot.app2.mapProcess.control
{
   ...
   public class WeeklyVSController_hell
   {
      ...
      public static const TARGET_MAP:uint = 974;
      
      private static const BUFFER_ID:uint = 22425;
      
      private static const FOREVER_ID:uint = 14068;
      
      private static var _startBossId:int = 1176;
      
      private static var _mapAnimate:String = "map_974_2";
      
      private static var _fulMovie:String = "active_20140430_3";
      
      private static var _mainPanel:String = "HellBeastVsChuangshibinhunMainPanel";
      
      private static var beginDate:Date = new Date(2016,4 - 1,22);
      
      private static var endDate:Date = new Date(2016,4 - 1,28);
      
      private static var activeTimes:Array = [14,18];
      
      private static var timeStr:String = "4月22日—4月28日，14:00-15:00，18:00-19:00";
      
      public static const TIME_TXT:String = timeStr;
      
      private static var _reward:String = "地狱兽的精元、创世兵魂的精元，以及专属全能刻印！更有终极隐藏技能等你激活！";
      
      private static var _broadcastMsg:String = "创世兵魂VS地狱兽，正义与邪恶的对抗！地狱兽最后的抉择是什么？快去看看吧！  ";
      
      private static var _tipStr:String = "地狱兽VS创世兵魂！";
      
      private static const ENTER_MAP_CODE:int = 86073473;
      
      private static const GET_PRE_TASK_CODE:int = 86073474;
      
      private static const COMPLETE_PRE_TASK_CODE:int = 86073475;
      
      private static const CLICK_MAP_ICON_CODE:int = 86073476;
      
      private static const CLICK_TRANSMIT_CABIN_EQUIP_CODE:int = 86073477;
      
      private static const CLICK_LOOK_CABIN_EQUIP_CODE:int = 86073478;
      
      private static const CLICK_ACTIVE_ICON_CODE:int = 86073479;
      
      private static const FIGHT_START_TIMES_CODE:int = 86073489;
      ...
      public function WeeklyVSController_hell()
      {
         super();
      }
      ...
      private static function startPreTask() : void
      {
         ...
         story = [[TaskStoryPlayer.MAP_MOVIE,[taskMc,1,"mc1"]],[TaskStoryPlayer.DIALOG,[NPC.YOUMANSI,["邪不胜正！正义的一方永远都是胜利者！现在他已经成为我的伙伴！放弃你的野心吧！ "],["真的吗？"]]],[TaskStoryPlayer.DIALOG,[NPC.MOLINGKING,["伙伴？哼！我有实力创造地狱兽！就有实力毁灭他！"],["你想做什么？"]]],[TaskStoryPlayer.DIALOG,[NPC.MOLINGKING,["天魔组织的行事准则：我得不到的东西，你们也休想得到！今天，我就要毁灭地狱兽！"],["不要！"]]],[TaskStoryPlayer.MAP_MOVIE,[taskMc,2,"mc2"]],[TaskStoryPlayer.DIALOG,[NPC.MOLINGKING,["记住，你永远都是至高无上的地狱兽！谁都不能击败你！你的主人只有我！. "],["遵命，主人！"]]],[TaskStoryPlayer.DIALOG,[NPC.DIYUSHOU,["是的！我是强大的地狱兽！没有谁能够击败我！我是世界的王者！ "],["清醒点！"]]],[TaskStoryPlayer.MAP_MOVIE,[taskMc,3,"mc3"]],[TaskStoryPlayer.FUL_MOVIE,[_fulMovie,true]],[TaskStoryPlayer.MAP_MOVIE,[taskMc,4,"mc4"]]];
      ...
      private static function onDialog(param1:MouseEvent) : void
      {
         ...
         if(activeStatus == ACTIVE)
         {
            ...
            {
               if(_loc2_ == "diyushou" && _curStep % 2 == 1)
               {
                  isFight = true;
                  FightManager.fightNoMapBoss("地狱兽",_startBossId + _curStep);
               }
               else if(_loc2_ == "chuangshibinhun" && _curStep % 2 == 0)
               {
                  isFight = true;
                  FightManager.fightNoMapBoss("创世兵魂",_startBossId + _curStep);
               }
               return;
            }
            switch(_loc2_)
            {
               case "chuangshibinhun":
                  NpcDialog.show(NPC.CHUANGSIBINGHUN,[nick + "，和我一起以正义之名召唤地狱兽吧！参加活100%获得" + reward],["我一定会的！"]);
                  break;
               case "diyushou":
                  NpcDialog.show(NPC.DIYUSHOU,[nick + "，我仿佛被体内的魔石能量控制一样！你一定要救救我！参加活100%获得" + reward],["我一定会的！"]);
                  break;
               case "youmansi":
                  NpcDialog.show(NPC.YOUMANSI,[nick + "，和创世兵魂一起以正义之名召唤地狱兽吧！参加活100%获得" + reward],["我一定会的！"]);
            }
            return;
         }
         switch(_loc2_)
         {
            case "chuangshibinhun":
               NpcDialog.show(NPC.CHUANGSIBINGHUN,[timeTip + "；我要唤醒地狱兽的正义！参加活动100%获得" + reward],["我一定会来的！"]);
               break;
            case "diyushou":
               NpcDialog.show(NPC.DIYUSHOU,[timeTip + "；我要接受创世兵魂的挑战！参加活动100%获得" + reward],["我一定会来的！"]);
               break;
            case "youmansi":
               NpcDialog.show(NPC.YOUMANSI,[timeTip + "；地狱兽会接受正义的召唤！参加活动100%获得" + reward],["我一定会来的！"]);
         }
      }
      ...
      private static function addYellowArrow(param1:int) : void
      {
         ...
         if(param1 % 2 == 0)
         {
            CommonUI.addYellowArrow(_map.topLevel,744,228,0);
         }
         else if(param1 % 2 == 1)
         {
            CommonUI.addYellowArrow(_map.topLevel,183,200,0);
         }
      }
      ...
      private static function startEnterMc(param1:Function = null) : void
      {
         ...
         _map.depthLevel.visible = false;
         CommonUI.removeYellowArrow(_map.topLevel);
         story = [[TaskStoryPlayer.MAP_MOVIE,[taskMc,5,"mc5"]],[TaskStoryPlayer.DIALOG,[NPC.SEER,["地狱兽！你要坚持住！创世兵魂一定能够召唤你的正义！你一定能够成为我们的伙伴！"],["可是我好难受！"]]],[TaskStoryPlayer.DIALOG,[NPC.DIYUSHOU,["我是魔石精灵，我拥有强大的魔石能量！我的使命就是彻底消灭你们！啊！啊！啊！"],["事不宜迟！"]]]];
         storyPlayer = new TaskStoryPlayer();
         storyPlayer.addStory(story);
         storyPlayer.storyEndCallback = function():void
         {
      ...
      private static function startFight() : void
      {
         ...
         {
            index = 6;
            msg1 = "地狱兽，你怎么样？你一定要控制住体内的魔石能量啊！记住，我们都代表正义！我们一定会击败魔灵王的！";
            bossName = "创世兵魂";
            NPCID = int(NPC.CHUANGSIBINGHUN);
         }
         else if(round % 2 == 1)
         {
            index = 7;
            msg1 = "创世兵魂，你不可能抵抗魔石的能量！我这就彻底消灭你！ ";
            bossName = "地狱兽";
            NPCID = int(NPC.DIYUSHOU);
         }
      ...
      private static function endFight() : void
      {
         ...
         if(_loc1_ % 2 == 0)
         {
            NpcDialog.show(NPC.CHUANGSIBINGHUN,[nick + "，没想到你的实力也这么强，和我一起用正义召唤地狱兽吧！参加活100%获得" + reward],["我会继续努力的！"]);
         }
         else if(_loc1_ % 2 == 1)
         {
            NpcDialog.show(NPC.DIYUSHOU,[nick + "，我仿佛被体内的魔石能量控制一样！你一定要救救我！参加活100%获得" + reward],["我会继续努力的！"]);
         }
      }
      ...
      private static function startOverMc(param1:Function) : void
      {
         ...
         KTool.hideMapAllPlayerAndMonster();
         _map.depthLevel.visible = false;
         story = [[TaskStoryPlayer.DIALOG,[NPC.DIYUSHOU,[nick + "，，快去看看创世兵魂怎么样？我感觉自己体内的魔石能量正在一点点的消除！我一定会被正义的能量召唤的！ "],["我没事！"]]],[TaskStoryPlayer.DIALOG,[NPC.CHUANGSIBINGHUN,["魔石能量能够控制精灵的本性！让精灵成为魔灵王的傀儡！我们千万不能大意！"],["那我们怎么办？!"]]],[TaskStoryPlayer.DIALOG,[NPC.NAINUOLITE,["让我们继续下去！" + nick + ",不要忘记了时间哦！" + timeTip + "！"],["不会忘，我会回来的！"]]]];
         storyPlayer = new TaskStoryPlayer();
         storyPlayer.addStory(story);
         storyPlayer.storyEndCallback = function():void
         {
      ...
      private static function startFinishMc(param1:Function = null) : void
      {
         ...
         KTool.hideMapAllPlayerAndMonster();
         _map.depthLevel.visible = false;
         story = [[TaskStoryPlayer.MAP_MOVIE,[taskMc,8,"mc8"]],[TaskStoryPlayer.DIALOG,[NPC.CHUANGSIBINGHUN,["地狱兽，记住我们都是正义的使者！永远都不能被邪恶势力控制！   "],["嗯！我知道！"]]],[TaskStoryPlayer.DIALOG,[NPC.DIYUSHOU,["只要有我在的一天，正义就不能缺失！宇宙就必须存在光明！"],["好样的，地狱兽！"]]],[TaskStoryPlayer.MAP_MOVIE,[taskMc,9,"mc9"]]];
         storyPlayer = new TaskStoryPlayer();
         storyPlayer.addStory(story);
         storyPlayer.storyEndCallback = function():void
         {
      ...
      private static function get currentStepTips() : String
      {
         ...
         if(_loc1_ == 9)
         {
            return "奖励创世兵魂专属全能刻印，地狱幻魄，泰坦之灵X300";
         }
         if(_loc1_ == 10)
         {
            return "奖励地狱兽专属全能刻印，地狱幻魄，泰坦之灵X300";
         }
         if(_loc1_ == 11)
         {
            return "奖励创世兵魂的精元，十万经验券，泰坦之灵X300";
         }
         if(_loc1_ == 12)
         {
            return "奖励地狱兽的精元，十万经验券，泰坦之灵X300";
         }
         return "奖励地狱幻魄，泰坦之灵X300";
      }
      ...
      private static function onGetMsgTime(param1:SocketEvent) : void
      {
         ...
         {
            LocalMsgController.addLocalMsg("TwelveRounds/WeeklyVSMsgPanel_hell",0,false,null,null,1);
