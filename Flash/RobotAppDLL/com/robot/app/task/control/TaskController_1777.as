package com.robot.app.task.control
{
   ...
   public class TaskController_1777
   {
      
      public static const TASK_ID:uint = 1777;
      ...
      public static const MAP_LOCAL_ID1:int = 10354;
      
      public static const MAP_LOCAL_ID2:int = 10355;
      
      public static const MAP_LOCAL_ID3:int = 10356;
      ...
      public function TaskController_1777()
      {
         super();
      }
      ...
      {
         NpcDialog.show(NPC.SHIPER,[MainManager.actorInfo.formatNick + "，索伦森正在利用逆界之门的力量，重生暗黑战神联盟，暗黑雷伊伊兰迪已经现身！"],["船长，我们快去阻止他！","不关我们的事吧……"],[function():void
         {
      ...
      {
         var mod1:TaskMod = new TaskMod(TaskDiaLogManager.DIALOG,NPC.SHIPER,["逆界之门的存在始终是个隐患，会带来无穷的危险，玛法里奥和战神联盟已经决定去摧毁逆界之门了！"],["太好了，战神联盟一定会成功的！"]);
         var mod2:TaskMod = new TaskMod(TaskDiaLogManager.DIALOG,NPC.SHIPER,["快去帮助他们吧，这一定会是场激烈的战斗！"],["交给我吧船长！"]);
