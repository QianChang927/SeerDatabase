package com.robot.app.task.control
{
   ...
   public class TaskController_3003
   {
      
      public static const TASK_ID:uint = 3003;
      ...
      public static const MAP_LOCAL_ID1:int = 10517;
      
      public static const MAP_LOCAL_ID2:int = 10518;
      
      public static const MAP_LOCAL_ID3:int = 10519;
      
      public static const MAP_LOCAL_ID4:int = 10520;
      ...
      public function TaskController_3003()
      {
         super();
      }
      ...
      {
         var dialogArr:Array = [MainManager.actorInfo.formatNick + "，缪斯执意重返妖石山，希望能够调查清楚伊洛维奇的身份！大家该怎么办？快去看看发生了什么事！"];
