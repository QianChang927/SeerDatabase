package com.robot.app.mapProcess
{
   ...
   public class MapProcess_52 extends BaseMapProcess
   {
      ...
      private function nonoMcEnterFrame(param1:Event) : void
      {
         ...
         {
            if(this._nono_mc.nono_mc.no_mc)
            {
      ...
      {
         var _loc4_:uint = 0;
         var _loc1_:Array = new Array(0,1,2,3,4,5);
         var _loc2_:Array = new Array();
         var _loc3_:uint = 0;
         while(_loc3_ < 2)
         {
            _loc4_ = uint(Math.random() * _loc1_.length);
            _loc2_.push(_loc1_[_loc4_]);
            _loc1_.splice(_loc4_,1);
            _loc3_++;
         }
         this._bao_0 = conLevel["bao_" + _loc2_[0]];
         this._bao_1 = conLevel["bao_" + _loc2_[1]];
         this._btn_0 = conLevel["btn_" + _loc2_[0]];
         this._btn_1 = conLevel["btn_" + _loc2_[1]];
         this._b_0 = conLevel["b_" + _loc2_[0]];
         this._b_1 = conLevel["b_" + _loc2_[1]];
      ...
      private function getBears(param1:uint, param2:String, param3:uint) : void
      {
         ...
         {
            DebugTrace.show(param1.outCount);
      ...
      private function clickLeaf(param1:MouseEvent) : void
      {
         ...
         if(MainManager.actorModel.nono)
         {
            ...
            if(info.superNono)
            {
               ...
               this.t1 = setTimeout(this.changeLeafStatus,1200,r);
            }
            else
            {
