package com.robot.app.mapProcess
{
   ...
   public class MapProcess_111 extends BaseMapProcess
   {
      ...
      override protected function init() : void
      {
         ...
         this.initPet();
         this._fightPanel = MapManager.currentMap.libManager.getMovieClip("ui_pet_king_panel");
         ...
         conLevel["exchangeCard_btn"].addEventListener(MouseEvent.CLICK,this.onExchangeCardBtnClick);
         ToolTipManager.add(conLevel["exchangeCard_btn"],"各系奖牌兑换");
         MapListenerManager.add(conLevel["PolarisBtn"],function():void
         {
            AnimateManager.playFullScreenAnimate(ClientConfig.getFullMovie("gotoPolaris"),function():void
            {
               MapManager.changeMap(763);
               SocketConnection.send(1022,86048941);
            });
         },"北极星守护阵");
      ...
      private function onClickPet(param1:MouseEvent) : void
      {
         ...
         MainManager.actorModel.moveAndAction(new Point(650,130),function():void
         {
            FightManager.fightWithBoss("卡塔",0);
         });
      }
      ...
      private function onFightBtnClick(param1:MouseEvent) : void
      {
         ...
         SysSOManager.freshLastSys(14001);
         SocketConnection.send(1022,86053850);
      }
      ...
      {
         var _startFightBtn:SimpleButton;
         var _closeBtn:SimpleButton;
         var txt:TextField = null;
         var str:String = null;
         var t:uint = param1;
         var mc:MovieClip = this._fightPanel["mc"];
         txt = this._fightPanel["txt"];
         mc.gotoAndStop(t);
      ...
      private function onStartFight(param1:MouseEvent) : void
      {
         ...
         var _loc3_:String = String(PetXMLInfo.getTypeCN(_loc2_.id));
         if(NAME_ARR.indexOf(_loc3_) + 1 == this._fightType)
         {
            this.startFight();
         }
         else
      ...
      private function startFight() : void
      {
         ...
         FightDispatcher.addEventListener(PetFightEvent.START_FIGHT,this.onPetStartFight);
         ...
         this.timeOutId = setTimeout(function():void
         {
            ...
            closeKingFight();
            SocketConnection.send(CommandID.FIGHT_NPC_BOSS,_fightType);
         },30000);
      }
      ...
      {
         FightDispatcher.removeEventListener(PetFightEvent.START_FIGHT,this.onPetStartFight);
         FightDispatcher.addEventListener(PetFightEvent.ALARM_CLICK,this.onFightClose);
      }
      ...
      private function onCancelHandler(param1:SocketEvent) : void
      {
         ...
         FightDispatcher.removeEventListener(PetFightEvent.ALARM_CLICK,this.onFightClose);
      }
