package com.robot.core.teamPK
{
   ...
   public class TeamInfoPanel
   {
      ...
      public function addHomeScore(param1:uint) : void
      {
         this._homeScore_txt.text = String(uint(this._homeScore_txt.text) + param1);
      }
      
      public function addAwayScore(param1:uint) : void
      {
         this._awayScore_txt.text = String(uint(this._awayScore_txt.text) + param1);
      }
