package com.robot.core.uic
{
   ...
   public class UIScrollBar extends EventDispatcher
   {
      ...
      public function UIScrollBar(param1:Sprite, param2:Sprite, param3:int, param4:SimpleButton = null, param5:SimpleButton = null, param6:Boolean = true)
      {
         super();
         ...
         if(param6)
         {
            if(this._upBtn)
            {
               ...
               this._upBtn.y = this._barBack.y + this._upBtn.height;
         ...
         else
         {
            if(this._upBtn)
            {
               this._upNum = this._upBtn.height;
               this._upBtn.x = this._barBack.x;
               this._upBtn.y = this._barBack.y + this._upBtn.height / 2;
               this._upBtn.mouseEnabled = false;
            }
            if(this._downBtn)
            {
               this._downNum = this._downBtn.height;
               this._downBtn.x = this._barBack.x;
               this._downBtn.y = this._barBack.y + this._barBack.height - this._downBtn.height / 2;
               this._downBtn.mouseEnabled = false;
            }
         }
      ...
      public function get barBlockIsShow() : Boolean
      {
         return this._barBlock.visible;
      }
