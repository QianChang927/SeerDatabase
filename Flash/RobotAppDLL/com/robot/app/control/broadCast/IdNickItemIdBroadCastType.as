package com.robot.app.control.broadCast
{
   ...
   public class IdNickItemIdBroadCastType implements IBroadCastType
   {
      ...
      public function IdNickItemIdBroadCastType()
      {
         super();
      }
      ...
      public function handleHtmlStr(param1:String, param2:MovieClip) : void
      {
         ...
         this._itemId = Broadcast2016Controller._currentInfo.msg.readUnsignedInt();
         this._itemInfo = ItemManager.getInfo(this._itemId);
         if(this._itemInfo == null)
         {
            this._itemInfo = new SingleItemInfo();
            this._itemInfo.itemID = this._itemId;
         }
         var _loc3_:String = String(String(ItemXMLInfo.getName(this._itemId)) || String(CountermarkXMLInfo.getDes(this._itemId)));
         param1 = param1.replace(/\$道具信息\$/g,_loc3_);
