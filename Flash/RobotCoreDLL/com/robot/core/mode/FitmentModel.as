package com.robot.core.mode
{
   ...
   public class FitmentModel extends SpriteModel
   {
      ...
      private static var _endS:Sound;
      
      private static var _endC:SoundChannel;
      ...
      private function extraClickFunc() : void
      {
         if(this._info.id == 540054)
         {
            this.playMusic(this._info.id);
         }
      }
      
      private function cancelClickFunc() : void
      {
         if(this._info.id == 540054)
         {
            this.destroySound();
      ...
      public function playMusic(param1:int) : void
      {
         this.destroySound();
         _endS = new Sound(new URLRequest(ClientConfig.getResPath("fitment/item/sound_" + param1 + ".mp3")));
         _endC = _endS.play(0,999);
      }
