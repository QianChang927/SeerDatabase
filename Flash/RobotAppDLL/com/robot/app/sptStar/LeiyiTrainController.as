package com.robot.app.sptStar
{
   ...
   public class LeiyiTrainController
   {
      ...
      {
         if(BufferRecordManager.getState(MainManager.actorInfo,319) == false)
         {
            BufferRecordManager.setState(MainManager.actorInfo,319,true);
         }
         creatIcon();
         if(!_trainApp)
         {
      ...
      public static function check(param1:Function) : void
      {
         ...
         if(_loc2_)
         {
            if(_loc2_.id == 70 || _loc2_.id == 2394)
            {
               param1();
            }
            else
      ...
      private static function startFight_0() : void
      {
         ...
         FightDispatcher.addEventListener(PetFightEvent.ALARM_CLICK,onFightComplete_0);
         if(MapManager.currentMap.id == 17)
         {
            FightManager.fightWithBoss("里奥斯",1,true,false);
         }
      }
      ...
      private static function onFightComplete_0(param1:PetFightEvent) : void
      {
         ...
         FightDispatcher.removeEventListener(PetFightEvent.ALARM_CLICK,onFightComplete_0);
      ...
      private static function startFight_1() : void
      {
         NpcDialog.show(NPC.TIYASI,["我的能力就是速度快，0xff0000雷雨天0xffffff应该可以在对战时发挥它的极限作用！记住了吗？"],["我要开始对战！"],[function():void
         {
            ...
            FightDispatcher.addEventListener(PetFightEvent.ALARM_CLICK,onFightComplete_1);
            if(MapManager.currentMap.id == 27)
            {
               FightManager.fightWithBoss("提亚斯",1,true,false);
            }
         }]);
      }
      ...
      {
         var e:PetFightEvent = param1;
         FightDispatcher.removeEventListener(PetFightEvent.ALARM_CLICK,onFightComplete_1);
         if((e.dataObj as FightOverInfo).winnerID == MainManager.actorID)
         {
            if(_isShow)
            {
      ...
      private static function startFight_2() : void
      {
         ...
         FightDispatcher.addEventListener(PetFightEvent.ALARM_CLICK,onFightComplete_2);
         if(MapManager.currentMap.id == 49)
         {
            FightManager.fightWithBoss("雷纳多",1,true,false);
         }
      }
      ...
      {
         var e:PetFightEvent = param1;
         FightDispatcher.removeEventListener(PetFightEvent.ALARM_CLICK,onFightComplete_2);
         if((e.dataObj as FightOverInfo).winnerID == MainManager.actorID)
         {
            if(_isShow)
            {
      ...
      private static function startFight_3() : void
      {
         ...
         FightDispatcher.addEventListener(PetFightEvent.ALARM_CLICK,onFightComplete_3);
         if(MapManager.currentMap.id == 40)
         {
            FightManager.fightWithBoss("阿克希亚",1,true,false);
         }
      }
      ...
      {
         var e:PetFightEvent = param1;
         FightDispatcher.removeEventListener(PetFightEvent.ALARM_CLICK,onFightComplete_3);
         if((e.dataObj as FightOverInfo).winnerID == MainManager.actorID)
         {
            if(_isShow)
            {
      ...
      public static function fightJiaLeiyi() : void
      {
         ...
         FightDispatcher.addEventListener(PetFightEvent.ALARM_CLICK,onFightComplete_4);
         if(MapManager.currentMap.id == 32)
         {
            FightManager.fightWithBoss("雷伊",7,true,false);
         }
      }
      ...
      {
         var e:PetFightEvent = param1;
         FightDispatcher.removeEventListener(PetFightEvent.ALARM_CLICK,onFightComplete_4);
         if((e.dataObj as FightOverInfo).winnerID == MainManager.actorID)
         {
            if(_isShow)
            {
