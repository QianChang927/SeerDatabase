package com.robot.app2.mapProcess.control
{
   ...
   public class PonySamsaraSanctuaryController
   {
      
      private static var _map:BaseMapProcess;
       
      
      public function PonySamsaraSanctuaryController()
      {
         super();
      }
      
      public static function initMap1111(param1:BaseMapProcess) : void
      {
         var map:BaseMapProcess = param1;
         _map = map;
         playMovie("pony_samsara_sanctuary_pre",22868,function():void
         {
            _map.conLevel.addEventListener(MouseEvent.CLICK,onClick);
         });
      }
      
      public static function destroyMap1111() : void
      {
      ...
      private static function onClick(param1:MouseEvent) : void
      {
         ...
         if(_loc2_ == "btnPony")
         {
            ModuleManager.showAppModule("PonySamsaraSanctuaryMainPanel");
         }
      }
   }
}
