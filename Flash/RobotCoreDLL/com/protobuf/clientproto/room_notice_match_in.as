package com.protobuf.clientproto
{
   ...
   public final dynamic class room_notice_match_in extends Message
   {
      
      public static const ROOMID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("com.protobuf.clientproto.room_notice_match_in.roomid","roomid",1 << 3 | WireType.VARINT);
       
      
      public var roomid:uint;
      
      public function room_notice_match_in()
      {
         super();
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc4_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: room_notice_match_in.roomid cannot be set twice.");
                  }
                  _loc3_++;
