...
{
   import com.robot.app.control.SeerPVPArenaController;
   ...
   public class FightMatchingPanel
   {
      ...
      public static function show(param1:Function) : void
      {
         if(_ui == null)
         {
            ...
            _close = param1;
            if(SeerPVPArenaController.FROM_PVP_ARENSA)
            {
               ResourceManager.getResource(ClientConfig.getAppRes("FightWait"),onLoadPvpMC,"PVPArenaFightWait_mc",3,false);
            }
            else
            {
               ResourceManager.getResource(ClientConfig.getAppRes("FightWait"),onLoadTopFightMC,"TopFightWait_mc",3,false);
            }
      ...
      private static function onCloseClick(param1:MouseEvent) : void
      {
         ...
         if(SeerPVPArenaController.FROM_PVP_ARENSA)
         {
            SeerPVPArenaController.FROM_PVP_ARENSA = false;
         }
      }
      ...
      private static function removePanel() : void
      {
         if(_ui != null)
         {
            ...
            ResourceManager.cancel(ClientConfig.getAppRes("FightWait"),onLoadPvpMC);
            ResourceManager.cancel(ClientConfig.getAppRes("FightWait"),onLoadTopFightMC);
         }
      }
   }
}
