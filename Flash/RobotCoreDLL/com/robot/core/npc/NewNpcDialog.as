package com.robot.core.npc
{
   ...
   public class NewNpcDialog
   {
      
      private static var _npcBmp:Bitmap;
      
      private static var _nameBmp:Bitmap;
      ...
      private static var _curNpcNamePath:String;
      ...
      {
         _bgMc = UIManager.getMovieClip("NPC_BG_MC_NEW");
      ...
      public static function show(param1:uint, param2:Array, param3:Array = null, param4:Array = null, param5:Boolean = false, param6:Function = null) : void
      {
         ...
         if(_nameBmp)
         {
            DisplayUtil.removeForParent(_nameBmp);
            _nameBmp = null;
         }
         btnBox.alpha = 0;
         ...
         if(_curNpcNamePath != "")
         {
            ResourceManager.cancelURL(_curNpcNamePath);
         }
         if(_npcBmp)
         {
            DisplayUtil.removeForParent(_npcBmp);
         ...
         btnBox.removeAll();
         _npcId = npcId;
         _curNpcPath = NPC.getDialogNewNpcPathByID(npcId);
         _curNpcNamePath = NPC.getDialogNewNpcNamePathByID(npcId);
         _curIndex = 0;
         _dialogA = dialogA;
         ...
         ResourceManager.getResource(_curNpcNamePath,onNameResComHandler);
      ...
      private static function onComHandler(param1:DisplayObject) : void
      {
         ...
         _bgMc.addChildAt(_npcBmp,0);
         _npcBmp.alpha = 1;
         LevelManager.root.mouseEnabled = false;
         LevelManager.root.mouseChildren = false;
         _npcBmp.x = 130 - _npcBmp.width / 2;
         _npcBmp.y = 188 - _npcBmp.height - 120;
      ...
      private static function onNameResComHandler(param1:DisplayObject) : void
      {
         var _loc2_:Number = _bgMc.height;
         _nameBmp = DisplayUtil.copyDisplayAsBmp(param1);
         _bgMc.addChild(_nameBmp);
         _nameBmp.x = 110 - _nameBmp.width / 2;
         _nameBmp.y = 0 - _nameBmp.height / 2;
      }
