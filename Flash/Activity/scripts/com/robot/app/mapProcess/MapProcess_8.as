package com.robot.app.mapProcess
{
   ...
   public class MapProcess_8 extends BaseMapProcess
   {
      ...
      private function update() : void
      {
         ...
         {
            if(Boolean(SystemTimerManager.getIsInActivity("20250110","2025011710")) && !BitUtils.getBit(param1[0],20))
            {
               conLevel["anbianHeziBtn"].visible = true;
            }
            else
            {
               conLevel["anbianHeziBtn"].visible = false;
            }
         });
      }
      ...
      private function onConclickHandle(param1:MouseEvent) : void
      {
         ...
         switch(btnName)
         {
            case "anbianHeziBtn":
               ...
               {
                  topLevel["boxAnim"].visible = false;
                  SocketConnection.sendByQueue(41900,[103,21],function(param1:*):void
                  {
                     update();
                  });
               },false,true);
