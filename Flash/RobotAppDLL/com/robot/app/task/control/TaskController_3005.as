package com.robot.app.task.control
{
   ...
   public class TaskController_3005
   {
      
      public static const TASK_ID:uint = 3005;
      ...
      public static const MAP_LOCAL_ID1:int = 10523;
      
      public static const MAP_LOCAL_ID2:int = 10524;
      
      public static const MAP_LOCAL_ID2_TEMP:int = 993;
      
      public static const MAP_LOCAL_ID3:int = 10525;
      
      public static const MAP_LOCAL_ID4:int = 10526;
      ...
      public function TaskController_3005()
      {
         super();
      }
      ...
      {
         var dialogArr:Array = [MainManager.actorInfo.formatNick + "，伊洛维奇竟然是缪斯的哥哥！太不可思议了！快去和先锋队一起，去看看发生了什么事！"];
