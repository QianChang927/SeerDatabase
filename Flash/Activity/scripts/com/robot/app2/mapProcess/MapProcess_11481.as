package com.robot.app2.mapProcess
{
   ...
   public class MapProcess_11481 extends BaseMapProcess
   {
       
      
      public function MapProcess_11481()
      {
         super();
      }
      ...
      override protected function init() : void
      {
         ...
         KTool.getMultiValue([18202],function(param1:Array):void
         {
            ...
            while(_loc4_ < 5)
            {
               ...
               depthLevel["boss_" + _loc4_].visible = _loc2_;
               MapListenerManager.add(depthLevel["boss_" + _loc4_],onclick);
               _loc4_++;
            }
      ...
      private function update() : void
      {
         KTool.getMultiValue([18202],function(param1:Array):void
         {
            ...
            if(u == 5)
            {
               Alarm.show("你在海盗的据点中搜索了一番，找到了一些宝贝.",function():void
               {
      ...
      private function onclick(param1:MouseEvent) : void
      {
         ...
         FightManager.fightNoMapBoss("",9348,false,true,function():void
         {
