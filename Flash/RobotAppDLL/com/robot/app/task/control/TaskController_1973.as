package com.robot.app.task.control
{
   ...
   public class TaskController_1973
   {
      
      public static const TASK_ID:uint = 1973;
      ...
      public static const MAP_LOCAL_ID1:int = 10479;
      
      public static const MAP_LOCAL_ID2:int = 10480;
      
      public static const MAP_LOCAL_ID3:int = 10481;
      
      public static const MAP_LOCAL_ID4:int = 10482;
      ...
      public function TaskController_1973()
      {
         super();
      }
      ...
      {
         NpcDialog.show(NPC.SHIPER,[MainManager.actorInfo.formatNick + "，海盗集团来势汹汹，贾斯汀站长正在全力抵抗！我们不能让海盗集团得逞！我们一定会胜利的，快加入到战斗中吧！ "],["我立刻就去！（奖励十万经验券，上等体力药剂，泰坦之灵）","让我先准备一下！"],[function():void
         {
