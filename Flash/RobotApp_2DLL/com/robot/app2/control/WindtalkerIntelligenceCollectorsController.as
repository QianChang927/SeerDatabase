package com.robot.app2.control
{
   ...
   public class WindtalkerIntelligenceCollectorsController
   {
      
      private static var _isTaskPlaying:Boolean;
      
      public static const BUFFER_ID:uint = 1214;
      ...
      public function WindtalkerIntelligenceCollectorsController()
      {
         super();
      }
      ...
      private static function startPreTask() : void
      {
         ...
         story = [[TaskStoryPlayer.FUL_MOVIE,["task_windtalkerIntelligenceCollectors",true]]];
      ...
      {
         ModuleManager.showModule(ClientConfig.getAppModule("WindtalkerIntelligenceCollectorsMainPanel"));
      }
      ...
      {
         ResourceManager.getResource(ClientConfig.getAppRes("MessengerXiaoyangTV"),function(param1:MovieClip):void
         {
            _widget = param1;
      ...
      {
         ModuleManager.showModule(ClientConfig.getAppModule("MessengerXiaoyangPanel"));
      }
