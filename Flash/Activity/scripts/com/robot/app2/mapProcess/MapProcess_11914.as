package com.robot.app2.mapProcess
{
   ...
   public class MapProcess_11914 extends BaseMapProcess
   {
      ...
      public function MapProcess_11914()
      {
         super();
      }
      ...
      public function update(param1:* = null) : void
      {
         ...
         KTool.getMultiValue([10970,10973],function(param1:Array):void
         {
            var _loc2_:int = 0;
            var _loc3_:int = 0;
            var _loc4_:int = 0;
      ...
      private function stopPlaying() : void
      {
         btnLevel["aniMc1"].visible = false;
         btnLevel["aniMc2"].visible = false;
         SocketConnection.sendByQueue(43330,[1,3],function(param1:*):void
         {
            update();
         });
      }
