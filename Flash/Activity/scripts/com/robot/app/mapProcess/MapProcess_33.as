package com.robot.app.mapProcess
{
   ...
   public class MapProcess_33 extends BaseMapProcess
   {
      ...
      {
         getDefinitionByName("com.robot.app2.mapProcess.control.ASignalThatNeverDisappearsController").initMap33(this);
         getDefinitionByName("com.robot.app2.mapProcess.control.ACallThatSpansThousandsOfYearsController").initMap33(this);
         conLevel["goto1711Btn"].visible = false;
         if(TasksManager.getTaskStatus(10) == TasksManager.COMPLETE)
         {
            ...
            this.configKey();
            conLevel["goto1711Btn"].visible = true;
            return;
         }
      ...
      override public function destroy() : void
      {
         ...
         if(this.isShow)
         {
            ...
            while(_loc1_ < 9)
            {
               if(conLevel["lockMc"]["mc" + _loc1_] != null)
               {
         ...
         getDefinitionByName("com.robot.app2.mapProcess.control.ASignalThatNeverDisappearsController").destroyMap33();
         getDefinitionByName("com.robot.app2.mapProcess.control.ACallThatSpansThousandsOfYearsController").destroyMap33();
      }
      ...
      private function configLock() : void
      {
         ...
         while(_loc1_ < 9)
         {
            _loc2_ = uint(uint(Math.random() * 4) + 1);
            conLevel["lockMc"]["mc" + _loc1_].buttonMode = true;
            conLevel["lockMc"]["mc" + _loc1_].gotoAndStop(_loc2_);
            conLevel["lockMc"]["mc" + _loc1_].addEventListener(MouseEvent.CLICK,this.onClickHandler);
            _loc1_++;
         }
      }
