package com.robot.module.app.petBag.subModule.petH5battleArray
{
   ...
   public class PetBagH5battleArrayFirstPetItemView extends PetBagSubModule
   {
      ...
      public function PetBagH5battleArrayFirstPetItemView(index:int, petInfo:PetInfo, type:int)
      {
         super();
         initUi("h5firstPetBagItem");
