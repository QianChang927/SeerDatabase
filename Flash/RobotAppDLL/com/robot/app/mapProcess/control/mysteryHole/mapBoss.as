package com.robot.app.mapProcess.control.mysteryHole
{
   ...
   public class mapBoss extends EventDispatcher
   {
      ...
      private static var instance:com.robot.app.mapProcess.control.mysteryHole.mapBoss;
      ...
      public static function getInstance() : com.robot.app.mapProcess.control.mysteryHole.mapBoss
      {
         if(!instance)
         {
            canotNew = false;
            instance = new com.robot.app.mapProcess.control.mysteryHole.mapBoss();
            canotNew = true;
         }
         return instance;
      }
