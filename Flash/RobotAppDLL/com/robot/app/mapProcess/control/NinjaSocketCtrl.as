package com.robot.app.mapProcess.control
{
   ...
   public class NinjaSocketCtrl extends EventDispatcher
   {
      ...
      private static var _instance:com.robot.app.mapProcess.control.NinjaSocketCtrl;
      ...
      public static function get instance() : com.robot.app.mapProcess.control.NinjaSocketCtrl
      {
         if(_instance == null)
         {
            _instance = new com.robot.app.mapProcess.control.NinjaSocketCtrl();
         }
         return _instance;
      }
      ...
      private function panelInfoHandler(param1:SocketEvent) : void
      {
         ...
         dispatchEvent(new DynamicEvent(com.robot.app.mapProcess.control.NinjaSocketCtrl.GET_PANEL_INFO,_loc3_));
      }
      ...
      private function zhenYanHandler(param1:SocketEvent) : void
      {
         ...
         dispatchEvent(new DynamicEvent(com.robot.app.mapProcess.control.NinjaSocketCtrl.GET_ZHEN_YAN));
      }
      ...
      private function getPetHandler(param1:SocketEvent) : void
      {
         ...
         _loc6_.push(_loc5_);
         dispatchEvent(new DynamicEvent(com.robot.app.mapProcess.control.NinjaSocketCtrl.GET_PET,_loc6_));
      }
      ...
      private function getNinjaToolsHandler(param1:SocketEvent) : void
      {
         ...
         dispatchEvent(new DynamicEvent(com.robot.app.mapProcess.control.NinjaSocketCtrl.GET_NINJA_TOOLS));
      }
      ...
      private function getNinjaSkillHandler(param1:SocketEvent) : void
      {
         ...
         dispatchEvent(new DynamicEvent(com.robot.app.mapProcess.control.NinjaSocketCtrl.GET_NINJA_SKILL,this.petid));
      }
