package com.robot.app.magicPassword
{
   ...
   public class MagicPasswordPanel extends Sprite
   {
      ...
      private const url:String = ClientConfig.getResPath("magicPassword/magicPassword.swf");
      ...
      private function onLoadUISuccessHandler(param1:MCLoadEvent) : void
      {
         ...
         this.main_ui["msg_txt"].htmlText = MainManager.actorInfo.nick + " : ";
      ...
      private function onSendBtnClickHandler(param1:MouseEvent) : void
      {
         ...
         {
            if(this.pass_txt.text.length != this.pass_txt.maxChars && this.pass_txt.text.length != 12)
            {
               Alarm.show("你输入的分子密码位数不对哦！");
               return;
            }
