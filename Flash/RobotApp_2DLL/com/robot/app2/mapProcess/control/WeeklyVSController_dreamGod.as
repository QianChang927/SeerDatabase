package com.robot.app2.mapProcess.control
{
   ...
   public class WeeklyVSController_dreamGod
   {
      ...
      private static const ACT_AC:ActivityControl = new ActivityControl([new CronTimeVo("*","14,19","15-21","1","*","2016")]);
      
      private static var lastDay:CronTimeVo = new CronTimeVo("*","*","21","1","*","2016");
      
      private static const BROADCAST_AC:ActivityControl = new ActivityControl([new CronTimeVo("55-60","13,18","15-21","1","*","2016")]);
      
      public static const TIME_TEXT:String = "1月15日-1月21日，14:00-15:00 19:00-20:00";
      ...
      public function WeeklyVSController_dreamGod()
      {
         super();
      }
      ...
      private static function onGetMsgTime(param1:SocketEvent) : void
      {
         ...
         {
            LocalMsgController.addLocalMsg("TwelveRounds/WeeklyVSMsgPanel_dreamGod",0,false,null,null,1);
      ...
      public static function initEquip() : void
      {
         ...
         if(MapManager.currentMap.id != TARGET_MAP)
         {
            ModuleManager.showModule(ClientConfig.getAppModule("TwelveRounds/WeeklyVSMsgPanel_dreamGod"),"正在努力打开面板...");
         }
         else
         {
