package com.robot.app.mapProcess
{
   ...
   import com.robot.app.task.taskscollection.Task772;
   ...
   public class MapProcess_314 extends BaseMapProcess
   {
      ...
      {
         SocketConnection.send(1022,86053216);
      ...
      private function onBossMCClickHandler(param1:MouseEvent) : void
      {
         ...
         {
            if(MapManager.currentMap.id == 314)
            {
