package com.robot.app.petbag.petPropsBag.petPropClass
{
   ...
   public class PetPropClass_300920
   {
       
      
      private var petInfo:PetInfo;
      
      public function PetPropClass_300920(param1:PetPropInfo)
      {
         super();
      ...
      private function onChange(param1:SocketEvent) : void
      {
         ...
         EventManager.dispatchEvent(new DynamicEvent("PetPropClass_300920",this.petInfo));
