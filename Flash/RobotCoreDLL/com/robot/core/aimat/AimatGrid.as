package com.robot.core.aimat
{
   ...
   public class AimatGrid extends Sprite
   {
      ...
      public function AimatGrid()
      {
         ...
         this.txt.x = 6;
         this.txt.y = 16;
         this.selectBox = UIManager.getMovieClip("throwSelectBox");
         this.selectBox.x = -1;
         this.selectBox.y = -1;
         this.selectBox.mouseChildren = this.selectBox.mouseEnabled = false;
         this.selectBox.visible = false;
         addChild(this.selectBox);
