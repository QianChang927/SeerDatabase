package com.protobuf.clientproto
{
   ...
   public final dynamic class match_result_notice_out extends Message
   {
      
      public static const RESULT:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("com.protobuf.clientproto.match_result_notice_out.result","result",1 << 3 | WireType.VARINT);
      
      public static const GROUP_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("com.protobuf.clientproto.match_result_notice_out.group_info","groupInfo",2 << 3 | WireType.LENGTH_DELIMITED,function():Class
      {
      ...
      public function match_result_notice_out()
      {
         super();
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc5_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: match_result_notice_out.result cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: match_result_notice_out.groupInfo cannot be set twice.");
                  }
                  _loc4_++;
