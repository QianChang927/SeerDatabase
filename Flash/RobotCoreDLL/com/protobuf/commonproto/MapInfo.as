package com.protobuf.commonproto
{
   ...
   public final dynamic class MapInfo extends Message
   {
      
      public static const IDX:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("com.protobuf.commonproto.MapInfo.idx","idx",1 << 3 | WireType.VARINT);
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc4_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: MapInfo.idx cannot be set twice.");
                  }
                  _loc3_++;
