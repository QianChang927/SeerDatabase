package com.robot.app.control.broadCast
{
   ...
   public class TeamBroadCastType implements IBroadCastType
   {
       
      
      private var ui:MovieClip;
      
      public function TeamBroadCastType()
      {
         super();
      }
      ...
      public function handleHtmlStr(param1:String, param2:MovieClip) : void
      {
         ...
         var _loc3_:String = String(Broadcast2016Controller._currentInfo.msg.readUTFBytes(16));
         param1 = param1.replace(/\$战队名称\$/g,_loc3_);
         var _loc4_:uint = uint(Broadcast2016Controller._currentInfo.msg.readUnsignedInt());
         param1 = param1.replace(/\$战队等级\$/g,_loc4_);
