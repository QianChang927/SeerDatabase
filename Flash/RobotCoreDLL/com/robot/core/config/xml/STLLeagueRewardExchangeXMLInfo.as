package com.robot.core.config.xml
{
   ...
   public class STLLeagueRewardExchangeXMLInfo
   {
      ...
      public function STLLeagueRewardExchangeXMLInfo()
      {
         super();
      }
      ...
      public static function setup(param1:Function) : void
      {
         ...
         _fun = callBack;
         PreloadZipXMLController.getXML("STLLeagueReward_xml.xml",function(param1:*):void
         {
            var _loc3_:XML = null;
