        ...
        e.prototype.next = function(t) {
            ...
            function() {
                ...
                function(a) {
                    switch (a.label) {
                    case 0:
                        return this.needPop.length < 1 ? (this.onClose(), [2]) : (ImageButtonUtil.remove(this.touchGroup), e = this.needPop.shift(), this.curPop = e, n = SystemTimerManager.sysDate, i = "SignInActivityPopUpPanel_id_" + e.id + "_" + MainManager.actorID, o = egret.localStorage.getItem(i), o && o == n.getFullYear() + "_" + (n.getMonth() + 1) + "_" + n.getDate() ? (this.next(t), [2]) : (e.daily && (egret.localStorage.setItem(i, n.getFullYear() + "_" + (n.getMonth() + 1) + "_" + n.getDate()), this.gou.source = "sign_in_activity_pop_up_panel_gou_png"), [4, RES.getResByUrl(this.url + (e.pic + ".png"),
                        function(n) {
