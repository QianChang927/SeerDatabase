package com.robot.app.freshFightLevel
{
   ...
   public class FightListPanel
   {
      ...
      private static function addItem(param1:ApplicationDomain) : void
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < defaultLength)
         {
            _loc3_ = new (param1.getDefinition("UI_Item") as Class)() as Sprite;
            _loc3_.x = 25;
            _loc3_.y = 17 + (_loc3_.height + 13) * _loc2_;
      ...
      {
         var _loc2_:String = String((param1.currentTarget as MovieClip)["txt"].text);
