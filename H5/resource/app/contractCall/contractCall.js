...
function(t) {
    var e = function(e) {
        ...
        n.prototype.addEvent = function() {
            ...
            function() {
                if (e.curInfo) {
                    var t = ItemManager.getNumByID(e.buyItemId),
                    n = t >= e.curInfo.cost ? 589568 : 16711680;
                    e.txt_price.textFlow = [{
                        text: t + "",
                        style: {
                            textColor: n
                        }
            ...
            function() {
                if ("1" == e.curInfo.type) {
                    ...
                    if (0 >= a || a < e.curInfo.cost) {
                        ...
                        s = "";
                        for (var m = 0,
                        d = PetManager.infos; m < d.length; m++) for (var l = d[m], p = 0; p < _.length; p++) if (l.id == ~~_[p]) {
                            if (g.indexOf(l.id) > -1) {
                                f = !0;
                                break
                            }
                        ...
                        if (s.length > 0 && (s = s.substring(0, s.length - 1)), f) return void Alarm.show("此次开启伙伴效果无法对同种精灵重复开启，请先确认需要开启伙伴效果的精灵在背包内有且仅有一只后再来开启伙伴效果！");
