package com.robot.app.task.control
{
   ...
   public class TaskController_1987
   {
      
      public static const TASK_ID:uint = 1987;
      ...
      public static const MAP_LOCAL_ID1:int = 10494;
      
      public static const MAP_LOCAL_ID2:int = 10495;
      
      public static const MAP_LOCAL_ID3:int = 10496;
      
      public static const MAP_LOCAL_ID4:int = 10497;
      ...
      public function TaskController_1987()
      {
         super();
      }
      ...
      {
         var dialogArr:Array = [MainManager.actorInfo.formatNick + "，克罗诺斯想要彻底摧毁卡修斯！宙斯正在奋力抵抗！卡修斯一定会苏醒的，快去寻找先锋队，一起去看看发生了什么事！"];
