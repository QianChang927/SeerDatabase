package com.robot.app.mapProcess
{
   ...
   public class MapProcess_425 extends BaseMapProcess
   {
      ...
      {
         SocketConnection.send(1022,84807521);
         ...
         this.onOneClick(null);
      }
      
      private function onOneClick(param1:MouseEvent = null) : void
      {
      ...
      private function onErlingChargeClick(param1:MouseEvent) : void
      {
         SocketConnection.send(1022,84807522);
      ...
      {
         var e:Event = param1;
         if(this._groundMc["arrow_mc"].hitTestPoint(MainManager.actorModel.pos.x,MainManager.actorModel.pos.y))
         {
      ...
      {
         this._isFight = true;
         FightManager.fightWithBoss("阿零",0);
         EventManager.addEventListener(RobotEvent.NO_PET_CAN_FIGHT,this.onFightError);
         FightDispatcher.addEventListener(PetFightEvent.CATCH_PET,this.onFightComplete);
      ...
      private function onFightError(param1:RobotEvent) : void
      {
         ...
         FightDispatcher.removeEventListener(PetFightEvent.CATCH_PET,this.onFightComplete);
