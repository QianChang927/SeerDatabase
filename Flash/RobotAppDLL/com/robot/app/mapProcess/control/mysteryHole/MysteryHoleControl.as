package com.robot.app.mapProcess.control.mysteryHole
{
   ...
   public class MysteryHoleControl
   {
      ...
      public var mysteryHoleBeen:com.robot.app.mapProcess.control.mysteryHole.MysteryHoleBeen;
      
      public var mysteryHoleConfig:com.robot.app.mapProcess.control.mysteryHole.MysteryHoleConfig;
      ...
      {
         this.mysteryHoleConfig = new com.robot.app.mapProcess.control.mysteryHole.MysteryHoleConfig();
         this.mysteryHoleBeen = new com.robot.app.mapProcess.control.mysteryHole.MysteryHoleBeen();
