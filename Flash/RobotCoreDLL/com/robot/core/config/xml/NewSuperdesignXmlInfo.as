package com.robot.core.config.xml
{
   ...
   public class NewSuperdesignXmlInfo
   {
      
      private static var xmlClass:Class = NewSuperdesignXmlInfo_xmlClass;
      
      private static var _xml:XML = XML(new xmlClass());
      
      private static var xmlClass1:Class = NewSuperdesignXmlInfo_xmlClass1;
      ...
      public function NewSuperdesignXmlInfo()
      {
         super();
      }
      ...
      private static function setup() : void
      {
         ...
         if(SystemTimerManager.splitVersion2022() == 0)
         {
            _xml = XML(new xmlClass());
         }
         else
         ...
         _loc3_ = _xml.elements("Moulds");
         _mouldsHashMap = new HashMap();
         for each(_loc4_ in _loc3_)
         {
            _mouldsHashMap.add(uint(_loc4_.@ID),_loc4_);
         }
      }
      ...
      public static function getConfigureInfoById(param1:int) : Object
      {
         ...
         var _loc4_:Object;
         (_loc4_ = new Object()).Exchange_pet = int(_loc3_[0].@Exchange_pet);
         _loc4_.Exchange_mintmark = String(_loc3_[0].@Exchange_mintmark) == "" ? -1 : int(_loc3_[0].@Exchange_mintmark);
         _loc4_.Exchange_newse = String(_loc3_[0].@Exchange_newse) == "" ? -1 : int(_loc3_[0].@Exchange_newse);
         _loc4_.Exchange_moves = String(_loc3_[0].@Exchange_moves) == "" ? -1 : int(_loc3_[0].@Exchange_moves);
         _loc4_.Times = int(_loc3_[0].@Times);
         _loc4_.ProgressValue = int(_loc3_[0].@ProgressValue);
         _loc4_.TimeValue = int(_loc3_[0].@TimeValue);
         _loc4_.exchangeIds = String(_loc3_[0].@ExchangeID).split(" ");
         _loc4_.productIds = String(_loc3_[0].@ExchangeProductID).split(" ");
         _loc4_.FailTimes = int(_loc3_[0].@FailTimes);
         _loc4_.spet = String(_loc3_[0].@Goto);
         _loc4_.prePetId = int(_loc3_[0].@needmon);
         return _loc4_;
      }
      
      public static function getSweepInfoById(param1:int) : Object
      {
         var _loc2_:XML = getDesignInfoByID(param1);
         var _loc3_:XMLList = _loc2_.elements("Sweep");
         var _loc4_:Object;
         (_loc4_ = new Object()).ItemID = String(_loc3_[0].@ItemID);
         _loc4_.ProductID = String(_loc3_[0].@ProductID);
         _loc4_.RuleID = String(_loc3_[0].@RuleID);
         return _loc4_;
      }
      ...
      public static function getBattleInfoById(param1:int, param2:int) : Object
      {
         ...
         _loc4_.BattleCnt = int(_loc3_.@BattleCnt);
         return _loc4_;
      }
      ...
      public static function getRulenfoById(param1:int, param2:int) : Object
      {
         var _loc5_:Object = null;
         var _loc6_:XML = null;
         var _loc3_:XML = getDesignInfoByID(param1);
         var _loc4_:XMLList = _loc3_.Rules[0].Rule;
         for each(_loc6_ in _loc4_)
         {
            if(int(_loc6_.@ID) == param2)
            {
               (_loc5_ = {}).ID = int(_loc6_.@ID);
               _loc5_.MouldID = int(_loc6_.@MouldID);
               _loc5_.Args = String(_loc6_.@Args);
               _loc5_.CheckTips = String(_loc6_.@CheckTips);
               _loc5_.FailTips = String(_loc6_.@FailTips);
               break;
            }
         }
         return _loc5_;
      ...
      public static function getAchieveXml(param1:int) : XML
      {
         ...
         if(_loc3_)
         {
            if((Boolean(_loc4_ = _loc3_.Achievement)) && Boolean(_loc4_.length))
            {
               _loc5_ = _loc4_[0];
      ...
      public function SuperdesignXmlInfo() : void
      {
      }
   }
}
