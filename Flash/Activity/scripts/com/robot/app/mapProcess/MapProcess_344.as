package com.robot.app.mapProcess
{
   ...
   public class MapProcess_344 extends BaseMapProcess
   {
      ...
      override protected function init() : void
      {
         ...
         getDefinitionByName("com.robot.app2.mapProcess.control.WeeklyVSController_takeximu").initForMap(this);
      }
      ...
      {
         getDefinitionByName("com.robot.app2.mapProcess.control.WeeklyVSController_takeximu").destroy();
         this.removeEvent();
         if(this.item_500640)
         {
            this.item_500640.removeEventListener(MouseEvent.CLICK,this.onClick_item_500640);
