package com.robot.core.info.teamPK
{
   ...
   public class TeamPKResultInfo
   {
      ...
      private var _gain_ghazi_badge:int;
      ...
      public function TeamPKResultInfo(param1:IDataInput = null)
      {
         super();
         if(param1)
         {
            ...
            this.isCan = Boolean(param1.readUnsignedInt());
            this._gain_coins = param1.readInt();
            this._gain_badge = param1.readInt();
            this._gain_ghazi_badge = param1.readInt();
      ...
      public function get gain_ghazi_badge() : int
      {
         return this._gain_ghazi_badge;
      }
