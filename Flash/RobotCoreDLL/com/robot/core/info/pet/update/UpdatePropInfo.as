package com.robot.core.info.pet.update
{
   ...
   public class UpdatePropInfo
   {
      ...
      public var ev_a:uint;
      
      public var ev_d:uint;
      ...
      public function UpdatePropInfo(param1:IDataInput)
      {
         ...
         this._expEgg = param1.readUnsignedInt();
         ...
         this.ev_a = param1.readUnsignedInt();
         this.ev_d = param1.readUnsignedInt();
      ...
      public function get expEgg() : uint
      {
         return this._expEgg;
      }
   }
