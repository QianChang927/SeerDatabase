package com.robot.app.mapProcess
{
   ...
   public class MapProcess_401 extends BaseMapProcess
   {
      ...
      private function fight6Boss(param1:MouseEvent) : void
      {
         ...
         NpcDialog.show(NPC.XUANWU,["我是帕诺星系的守护神，你能进到这里说明你已经是个能独挡一面的精英了，但是真正的挑战现在才开始。"],["不管什么挑战我都不怕。","使用玄武挑战令","使用玄武战符","我还是下次再来吧。"],[function():void
         {
            ...
            FightManager.fightWithBoss("玄武守护兽",0,true);
         },function():void
         {
            fightByItem();
         },function():void
      ...
      {
         ItemManager.upDateCollection(1700233,function():void
         {
            if(ItemManager.getNumByID(1700233) > 0)
            {
               SocketConnection.sendWithCallback(46050,function(param1:SocketEvent):void
               {
                  ...
                  FightManager.fightWithBoss("巴斯特",1,true);
               },1);
            }
            else
            {
