package com.robot.app2.control
{
   ...
   public class ChloeGreatShapeOutputController
   {
      
      private static var _isTaskPlaying:Boolean;
      
      public static const BUFFER_ID:uint = 1225;
      
      public static const BUFFER_ID2:uint = 1226;
      ...
      public function ChloeGreatShapeOutputController()
      {
         super();
      }
      ...
      private static function startPreTask() : void
      {
         ...
         story = [[TaskStoryPlayer.FUL_MOVIE,["task_ChloeGreatShapeOutput",true]]];
      ...
      {
         ModuleManager.showModule(ClientConfig.getAppModule("ChloeGreatShapeOutputMainPanel"),"正在打开....");
      }
      ...
      public static function start2() : void
      {
         ...
         {
            KTool.hideMapAllPlayerAndMonster();
            ResourceManager.getResource(ClientConfig.getMapAnimate("map_ChloeGreatShapeOutput"),function(param1:MovieClip):void
            {
               taskMc = param1;
      ...
      {
         ModuleManager.showModule(ClientConfig.getAppModule("ChloeGreatShapeOutputTheUltimateTestPanel"),"正在打开....");
      }
