package com.robot.app.quickWord
{
   ...
   public class QuickWordList extends Sprite
   {
      ...
      private var parentList:com.robot.app.quickWord.QuickWordList;
      
      private var subList:com.robot.app.quickWord.QuickWordList;
      ...
      public function QuickWordList(param1:XML, param2:com.robot.app.quickWord.QuickWordList = null)
      {
         super();
      ...
      private function listMC(param1:XMLList) : void
      {
         ...
         {
            (_loc6_ = UIManager.getMovieClip("quickWordListMC")).gotoAndStop(1);
            this.perHeight = _loc6_.height + 1;
            _loc6_.mouseChildren = false;
            this._totalHeight = this.perHeight * param1.length();
            (_loc7_ = _loc6_["txt"]).autoSize = TextFieldAutoSize.CENTER;
      ...
      public function getFirst() : com.robot.app.quickWord.QuickWordList
      {
         var _loc1_:com.robot.app.quickWord.QuickWordList = this;
      ...
      private function overHandler(param1:MouseEvent) : void
      {
         ...
         var _loc4_:XMLList;
         if((_loc4_ = XML(_loc2_.xml).elements("menu")).length() > 0)
         {
            this.subList = new com.robot.app.quickWord.QuickWordList(_loc2_.xml,this);
      ...
      private function clickHandler(param1:MouseEvent) : void
      {
         ...
         MainManager.actorModel.execBehavior(new ChatBehavior(_loc2_["txt"].text));
      }
      
      private function checkIsHit(param1:TimerEvent) : void
      {
         var _loc2_:com.robot.app.quickWord.QuickWordList = this.getFirst();
