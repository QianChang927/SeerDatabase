package com.robot.app.mapProcess
{
   ...
   public class MapProcess_404 extends BaseMapProcess
   {
      ...
      private function initCatchBoss() : void
      {
         ...
         this._progBarMC = MapManager.currentMap.libManager.getMovieClip("ProgBarMC");
         this._handMC = MapManager.currentMap.libManager.getMovieClip("CatchHandMC");
      ...
      {
         FightManager.fightWithBoss("霹雳兽",0);
      }
