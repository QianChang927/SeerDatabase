...
function(t) {
    var e = function(e) {
        function n(t) {
            var n = e.call(this) || this;
            return n.PosX4Arr = [ - 420, -230, 245, 425],
            n.PosY4Arr = [303, 374, 374, 303],
            n.PosX5Arr = [ - 430, -205, 0, 205, 430],
            n.PosY5Arr = [285, 355, 370, 355, 285],
        ...
        n.prototype.initPanel = function(e) {
            var n = this;
            if (this.imgBg.source = "detail_panel_bg_" + this.data.taskId + "_png", this.adaptBgByScale(this.imgBg), this.data.progress = t.AdvancedPetBackStore.petAdvInfos.getValue(this.data.petId).curProgress, this.data.progress < 0 ? (DisplayUtil.setEnabled(this.btnStartAdv, !1), this.btnStartAdv.visible = !0, this.grpBuyComp.visible = !1) : this.data.progress == this.data.allProgress ? null != e ? (DisplayUtil.setEnabled(this.btnStartAdv, !0), this.btnStartAdv.visible = !0, this.grpBuyComp.visible = !1) : (null == this.jinjieAnim && (this.jinjieAnim = SpineUtil.createAnimate("jinjie"), this.grpAnim.addChild(this.jinjieAnim), this.jinjieAnim.x = 10, this.jinjieAnim.y = 34), this.grpBuyComp.visible = !1, this.btnStartAdv.visible = !1, this.grpAnim.visible = !0, MainManager.stage.touchEnabled = MainManager.stage.touchChildren = !1, this.jinjieAnim.play("jinjie", 1, 0, {
                playEnd: function() {
            ...
            })) : (this.btnStartAdv.visible = !1, this.grpBuyComp.visible = !0), DisplayUtil.removeAllChild(this.grpComps), 4 == this.data.allProgress) for (var i = 1; i <= this.data.allProgress; i++) {
                var a = new t.AdvancedPetBackCompItem;
                a.setData(this.data.taskId, i, i <= t.AdvancedPetBackStore.petAdvInfos.getValue(this.data.petId).curProgress),
                this.grpComps.addChild(a),
                a.horizontalCenter = this.PosX4Arr[i - 1],
                a.y = this.PosY4Arr[i - 1]
            } else if (5 == this.data.allProgress) for (var i = 1; i <= this.data.allProgress; i++) {
                var a = new t.AdvancedPetBackCompItem;
                a.setData(this.data.taskId, i, i <= t.AdvancedPetBackStore.petAdvInfos.getValue(this.data.petId).curProgress),
                this.grpComps.addChild(a),
                a.horizontalCenter = this.PosX5Arr[i - 1],
                a.y = this.PosY5Arr[i - 1]
            }
        },
        n.prototype.destroy = function() {
...
function(t) {
    var e = function(e) {
        ...
        n.prototype.childrenCreated = function() {
            var n = this;
            e.prototype.childrenCreated.call(this),
            this.appearAnim = SpineUtil.createAnimate("mark"),
            this.grpAnim.addChild(this.appearAnim),
            this.appearAnim.visible = !1,
            this.bg.width = egret.lifecycle.stage.stageWidth;
            for (var i = PetAdvanceXMLInfo.getTaskInfo(this.taskId), a = i.AllProgress, o = i.Advances.MonsterId, r = t.AdvancedPetBackStore.petAdvInfos.getValue(o).curProgress, s = 0; 5 > s; s++) a - 1 > s || DisplayUtil.removeForParent(this["star_" + s]);
