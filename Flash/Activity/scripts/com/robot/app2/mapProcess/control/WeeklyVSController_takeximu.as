package com.robot.app2.mapProcess.control
{
   ...
   public class WeeklyVSController_takeximu
   {
      ...
      private static var beginTime:CronTimeVo = new CronTimeVo("*","13","15","5","*","2015");
      
      private static var activeTime_pm_1:CronTimeVo = new CronTimeVo("*","13","15-21","5","*","2015");
      
      private static var activeTime_ev_1:CronTimeVo = new CronTimeVo("*","18","15-21","5","*","2015");
      
      private static var lastDay:CronTimeVo = new CronTimeVo("*","*","21","5","*","2015");
      
      private static var broadcastTime_pm_1:CronTimeVo = new CronTimeVo("50-60","12","15-21","5","*","2015");
      
      private static var broadcastTime_ev_1:CronTimeVo = new CronTimeVo("50-60","17","15-21","5","*","2015");
      ...
      public function WeeklyVSController_takeximu()
      {
         super();
      }
      ...
      private static function onGetMsgTime(param1:SocketEvent) : void
      {
         ...
         {
            LocalMsgController.addLocalMsg("TwelveRounds/WeeklyVSMsgPanel_takeximu",0,false,null,null,1);
      ...
      public static function initEquip() : void
      {
         if(MapManager.currentMap.id != TARGET_MAP)
         {
            ModuleManager.showModule(ClientConfig.getAppModule("TwelveRounds/WeeklyVSMsgPanel_takeximu"),"正在努力打开面板...");
         }
         else
         {
      ...
      {
         return "0xff00005月15日-5月21日，13:00-14:00，18：00-19:000xffffff";
      }
