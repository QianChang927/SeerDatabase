package com.robot.app.mapProcess.control.spcaeMaze
{
   ...
   public class SpaceMazeController extends EventDispatcher
   {
      ...
      private static var _instance:SpaceMazeController;
      ...
      public static function getInstance() : SpaceMazeController
      {
         if(_instance == null)
         {
            _instance = new SpaceMazeController();
            _instance.setup();
         }
         return _instance;
      }
