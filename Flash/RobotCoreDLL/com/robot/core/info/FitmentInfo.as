package com.robot.core.info
{
   ...
   public class FitmentInfo
   {
      ...
      public function set id(param1:uint) : void
      {
         ...
         else if(this._id >= 500001 && this._id <= 500100 || this._id >= 510000 && this._id < 520000)
         {
            this.type = SolidType.FRAME;
         }
         else if(this._id >= 500101 && this._id <= 500300 || this._id >= 520000 && this._id < 540000)
         {
         ...
         else if(this._id >= 500501 && this._id <= 500800 || this._id >= 540000 && this._id < 580000)
         {
            this.type = SolidType.PUT;
         }
         else if(this._id >= 500801 && this._id < 510000 || this._id >= 580000 && this._id < 599999)
         {
