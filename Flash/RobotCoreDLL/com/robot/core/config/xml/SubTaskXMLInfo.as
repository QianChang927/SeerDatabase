package com.robot.core.config.xml
{
   ...
   public class SubTaskXMLInfo
   {
      ...
      public function SubTaskXMLInfo()
      {
         super();
      }
      ...
      private static function setup(param1:Function) : void
      {
         ...
         _urlLoader.load(new URLRequest(ClientConfig.getResPath("xml/sub_task_details.xml")));
      }
      
      private static function onLoadXMLComplete(param1:Event) : void
      {
         _xmlObject = XML(param1.target.data);
         _xmlList = _xmlObject.taskgrp.elements("task");
      ...
      public static function getTaskGrpXml(param1:uint, param2:Function) : void
      {
         var xml:XML = null;
         var id:uint = param1;
