package com.robot.app2.mapProcess.control
{
   ...
   public class CreatorArmorEvoController
   {
      ...
      private static const CUR_TASKNPC:int = 5;
      
      private static const _statues:Array = ["CreatorArmorPanel","SaintArcherMainPanel","GenesisWingPanel","CreatorRingPanel","CreatorShieldPanel","CreatorRapierPanel"];
      ...
      public function CreatorArmorEvoController()
      {
         super();
      }
      ...
      private static function onStatus(param1:MouseEvent) : void
      {
         ...
         {
            ModuleManager.showModule(ClientConfig.getAppModule("SaintArmorMainPanel"));
         }
      }
      ...
      {
         ResourceManager.getResource(ClientConfig.getMapAnimate("map_1023_saint_Rapier"),function(param1:MovieClip):void
         {
            var mod1:TaskMod;
            var mod2:TaskMod;
            var mod3:TaskMod;
            ...
            mod2 = new TaskMod(TaskDiaLogManager.DIALOG,NPC.CREATOR_RAPIER,["老伙计，我又回来了。"],["我已经等你很久了。"]);
            mod3 = new TaskMod(TaskDiaLogManager.DIALOG,NPC.CHUANGSHI_SHENGGONG,["创世神的最强攻击——创世圣剑，我们终于又见面了！"],["让我们再来像以前那样切磋一番吧！"]);
            mod4 = new TaskMod(TaskDiaLogManager.MAP_MOVIE,0,null,null,[taskMc,2,"mc1"]);
