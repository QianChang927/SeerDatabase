package com.protobuf.clientproto
{
   ...
   public final dynamic class xingchen_boss_out extends Message
   {
      
      public static const RESULT:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("com.protobuf.clientproto.xingchen_boss_out.result","result",1 << 3 | WireType.VARINT);
       
      
      public var result:uint;
      
      public function xingchen_boss_out()
      {
         super();
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc4_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: xingchen_boss_out.result cannot be set twice.");
                  }
                  _loc3_++;
