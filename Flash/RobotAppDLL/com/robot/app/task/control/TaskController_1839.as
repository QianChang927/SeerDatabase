package com.robot.app.task.control
{
   ...
   public class TaskController_1839
   {
      
      public static const TASK_ID:uint = 1839;
      ...
      public static const MAP_LOCAL_ID1:int = 10385;
      
      public static const MAP_LOCAL_ID2:int = 10386;
      
      public static const MAP_LOCAL_ID3:int = 10387;
      ...
      public function TaskController_1839()
      {
         super();
      }
      ...
      {
         NpcDialog.show(NPC.SHIPER,[MainManager.actorInfo.formatNick + "，宇宙中大量的能量被索伦森汇集于一点，整个宇宙的平衡即将被打破，届时各星系都会发生重大的灾难！"],["船长，我们该怎么办？"],[function():void
         {
      ...
      {
         var mod1:TaskMod = new TaskMod(TaskDiaLogManager.DIALOG,NPC.SHIPER,["梦境之神已经带领创世神兵前往魔君秘境了。第六星系的谜团正在一步步揭开。索伦森到底隐藏着什么阴谋呢？"],["我们也赶紧过去看看吧！"]);
         var mod2:TaskMod = new TaskMod(TaskDiaLogManager.DIALOG,NPC.SHIPER,["勇敢的赛尔，去吧！为了维护住宇宙的平静，我们必须出手相助。赛尔号不允许任何人打破宇宙的平衡。还有，小心赫尔墨斯！"],["好的！我们知道了！"]);
