package com.robot.app.mapProcess.active
{
   ...
   public class ActivePet extends ActionSpriteModel
   {
      ...
      private function checkDis(param1:Event) : void
      {
         ...
         if(this.isWalking)
         {
            if(_loc2_ < 50 && !this.isEscape)
            {
               ...
               {
                  _walk.execute_point(this,this.right.end(),false);
                  this.right.setToEnd();
                  this.currentPointList = this.right;
               }
               else
               {
                  _walk.execute_point(this,this.left.end(),false);
                  this.left.setToEnd();
                  this.currentPointList = this.left;
               }
            }
      ...
      {
         this.visible = true;
         _walk.execute_point(this,this.currentPointList.next(),false);
      }
      ...
      {
         var _loc1_:MovieClip = MapManager.currentMap.libManager.getMovieClip("yun_mc");
      ...
      {
         FightManager.fightWithBoss("达比拉");
      }
