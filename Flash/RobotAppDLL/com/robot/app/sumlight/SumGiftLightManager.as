package com.robot.app.sumlight
{
   ...
   public class SumGiftLightManager
   {
      
      private static var _instance:com.robot.app.sumlight.SumGiftLightManager;
      ...
      public function SumGiftLightManager()
      {
         super();
         if(null != _instance)
         {
            throw new Error("该实例需要通过 SumGiftLightManager.getInstance() 方法调用");
         }
      }
      
      public static function getInstance() : com.robot.app.sumlight.SumGiftLightManager
      {
         if(null == _instance)
         {
            _instance = new com.robot.app.sumlight.SumGiftLightManager();
         }
         return _instance;
      }
      ...
      public function loadXml(param1:Function) : void
      {
         ...
         this._xmlLoader.load(SumGiftLightConst.XML_URL);
      }
      ...
      {
         var _loc2_:SharedObject = SharedObject.getLocal(SumGiftLightConst.LOCAL_DATA_NAME);
         if(null != _loc2_)
         {
