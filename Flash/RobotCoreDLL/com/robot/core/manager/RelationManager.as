package com.robot.core.manager
{
   ...
   public class RelationManager
   {
      ...
      private static var _friendOnLineList:HashMap;
      ...
      private static function getVipNotice() : void
      {
         var _loc2_:uint = 0;
         ...
         {
            SocketConnection.send(CommandID.GET_FRIEND_NOTICE,4,RelationManager.friendIDs.length,_loc1_);
         }
      }
      ...
      public static function get friendOnLineIDs() : Array
      {
         return _friendOnLineList.getKeys();
      }
      
      public static function get friendOnLineInfos() : Array
      {
         return _friendOnLineList.getValues();
      }
      
      public static function init(param1:IDataInput) : void
      {
         ...
         while(_loc3_ < _loc2_)
         {
            (_loc5_ = new UserInfo()).userID = param1.readUnsignedInt();
            _loc5_.timePoke = param1.readUnsignedInt();
            _friendList.add(_loc5_.userID,_loc5_);
            _loc3_++;
         }
         ...
         while(_loc4_ < _loc2_)
         {
            (_loc6_ = new UserInfo()).userID = param1.readUnsignedInt();
            _blackList.add(_loc6_.userID,_loc6_);
            _loc4_++;
         }
         _friendOnLineList = new HashMap();
         soInit();
      }
      ...
      public static function addBlack(param1:uint) : void
      {
         ...
         SocketConnection.addCmdListener(CommandID.BLACK_ADD,function(param1:SocketEvent):void
         {
            ...
            var _loc5_:UserInfo;
            (_loc5_ = new UserInfo()).userID = _loc4_;
            _loc5_.timePoke = 0;
      ...
      public static function setOnLineFriend() : void
      {
         ...
         UserInfoManager.seeOnLine(arr,function(param1:Array):void
         {
            ...
            var _loc2_:int = 0;
            while(_loc2_ < _friendOnLineLength)
            {
               _loc3_ = param1[_loc2_] as OnLineInfo;
               if(_loc4_ = _friendList.getValue(_loc3_.userID) as UserInfo)
               {
                  _loc4_.mapID = _loc3_.mapID;
                  _loc4_.serverID = _loc3_.serverID;
                  _friendOnLineList.add(_loc4_.userID,_loc4_);
               }
               _loc2_++;
            }
            dispatchEvent(new RelationEvent(RelationEvent.FRIEND_UPDATE_ONLINE));
