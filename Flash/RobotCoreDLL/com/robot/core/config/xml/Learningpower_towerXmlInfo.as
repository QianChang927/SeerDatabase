...
{
   public class Learningpower_towerXmlInfo
   {
      
      private static var xmlClass:Class = Learningpower_towerXmlInfo_xmlClass;
      ...
      public function Learningpower_towerXmlInfo()
      {
         super();
      }
