package com.robot.app.exchangeCloth
{
   ...
   public class ExchangeClothPanel extends Sprite
   {
      ...
      private const url_str:String = ClientConfig.getResPath("exchangeCloth/blackExchange.swf");
      ...
      private function onEnterHandler(param1:Event) : void
      {
         ...
         if(this.currentE.totalFrames == this.currentE.currentFrame)
         {
            ...
            ExchangeClothXMLInfo.getExchangeIdByItemId(this.currentObj.id,function(param1:uint):void
            {
               SocketConnection.addCmdListener(CommandID.EXCHANGE_CLOTH_COMPLETE,onSuccess);
               SocketConnection.send(CommandID.EXCHANGE_CLOTH_COMPLETE,param1);
               destroy();
            });
         }
      }
