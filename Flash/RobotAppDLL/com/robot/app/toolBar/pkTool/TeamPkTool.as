package com.robot.app.toolBar.pkTool
{
   ...
   public class TeamPkTool
   {
      ...
      private static var _instance:com.robot.app.toolBar.pkTool.TeamPkTool;
       
      
      private var box:HBox;
      
      private var currentMouseIcon:com.robot.app.toolBar.pkTool.IPKMouseIcon;
      
      private var mouseIconList:Array;
      
      public function TeamPkTool()
      {
         var _loc1_:com.robot.app.toolBar.pkTool.IPKMouseIcon = null;
         this.mouseIconList = [];
         super();
      ...
      public static function get instance() : com.robot.app.toolBar.pkTool.TeamPkTool
      {
         if(!_instance)
         {
            _instance = new com.robot.app.toolBar.pkTool.TeamPkTool();
         }
         return _instance;
      }
      ...
      {
         this.currentMouseIcon = param1.currentTarget as com.robot.app.toolBar.pkTool.IPKMouseIcon;
